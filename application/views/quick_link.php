...
<body>
            ...
            <div class="page-content-wrap">
                                ...
                                <div class="row">
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <label class="control-label">Quick Links (English)*</label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="Quick Links (English)" name="title" id="title" required>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                                <label class="control-label">क्विक लिंक (मराठी)*</label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="क्विक लिंक (मराठी)" name="title_m" id="title_m" required>
                                            </div>
                                        </div>
                ...
                <div class="row ">
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Quick link Report</h3>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/quick_link.js"></script>
    <!--fileupload Files -->

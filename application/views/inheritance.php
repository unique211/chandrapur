...
<body>
    ...
    <div class="page-container page-navigation-toggled page-container-wide">
        ...
        <div class="page-content">
            ...
            <!-- START BREADCRUMB -->
            <ul class="breadcrumb">
                <li class="active">Inheritance certificate</li>
            </ul>
            <!-- END BREADCRUMB -->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Code Id : 02 Inheritance Certificate</h3>
                                <ul class="panel-controls">
                                    <li> <button class="btn btn-success btnhideshow" style="background-color:#00B050;">
                                            Add Inheritance Certificate
                                            Detail</button></li>
                                </ul>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <br>
                                    <h3 style="font-weight:bold;text-align:center;" id="10">-::वारसा हक्क
                                        प्रमाणपत्र::-</h3>
                                    <br>
                                    <!-- <form action="" class="form-horizontal" id="jvalidate" method="post" -->
                                    <!-- accept-charset="utf-8"> -->
                                    <section class="inheritance" id="marathi" style="vertical-align:center;">
                                        <div class="row" style="padding-left:35px;">
                                            <div class="form-group">
                                                <div class="col-sm-3 text_notes" id="0">प्रमाणित करण्यात
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3 text_notes" id="4"> यांना वारसा हक्क
                                                    प्रमाणपत्र देण्यात येत आहे.</div>
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3" style="text-align:center;">
                                                <b style="center"><label id="8">मुख्याधिकारी</b></label><br>
                                                <label id="9">चंद्रपूर शहर महानगरपालिका</label>
                                            </div>
                                        </div>
                                        <br><br><br>
                                        ...
                                        <div class="row center">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="btn-group " style="float:right;">
                                                    ...
                                                    <button class="btn btn-success" form="payment" id="pay" name="pay"
                                                        value="Inheritance_Certificate" type="submit">Pay
                                                        Online</button>
                                            ...
                                            <div class="col-sm-6" style="margin-left:-1%;">
                                                ...
                                                <form name="inherit" id="inherit" method="POST"
                                                    action="<?php echo base_url('Pdf_print/print_inherit');?>"
                                                    target="_blank"></form>
                                                <button class="btn btn-primary" type="submit" form="inherit"
                                                ...
                                                <form name="property2" id="property2" method="POST"
                                                    action="<?php echo base_url('Pdf_print/print_inherit_marathi');?>"
                                                    target="_blank"></form>
                                            </div>
                                        </div>
                                    </section>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/inheritance.js"></script>
    <!--fileupload Files -->
    ...
    $('#language').on('change', function() {
        ...
        if (lan == 'english') {
            ...
            newlabel4 = 'Their are given the inheritance Cerificate.';
            newlabel5 = 'Location:';

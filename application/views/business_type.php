...
<body>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 right_side">
						...
						<div class="panel panel-default">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">Business Type Form</h3>
									...
									<form class="form-horizontal" id="master_form" name="master_form">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												...
												<input type="text" placeholder="Business Type" class="form-control input-sm placeholdesize" id="business_type" name="business_type" required>
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
											<input type="number" min="0" placeholder="Amount" class="form-control input-sm placeholdesize" id="amount" name="amount" required>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 right_side">
						...
						<div class="panel panel-default">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">Business Type List</h3>
	...
	<script src="<?php echo base_url(); ?>assets/js/myjs/business_type.js"></script>

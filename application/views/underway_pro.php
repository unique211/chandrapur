...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <!-- START BREADCRUMB -->
            <ul class="breadcrumb">
                <li class="active">Currently underway project</li>
            </ul>
            <!-- END BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Ongoing project</h3>
                                ...
                                <div class="row">
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="शीर्षक" name="title_m" id="title_m" required>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="वर्णन" name="desc_m" id="desc_m" required>
                                            </div>
                ...
                <div class="row ">
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Report of ongoing project</h3>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/underway_pro.js"></script>
    <!--fileupload Files -->

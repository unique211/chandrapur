...
<body>
     ...
     <div class="page-container page-navigation-toggled page-container-wide">
          ...
          <div class="page-content">
               ...
               <!-- START BREADCRUMB -->
               <ul class="breadcrumb">
                    <li class="active">Resident Certificate</li>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                              ...
                              <div class="panel panel-default">
                                   <div class="panel-heading">
                                        <h3 class="panel-title">Code Id : 12 Resident Certificate</h3>
                                       
                                        <ul class="panel-controls">

                                             <li> <button class="btn btn-success btnhideshow"
                                                       style="background-color:#00B050;"> Add Resident certificate Detail</button></li>
                                        </ul>
                                   </div>
							...
							<h3 class="panel-title">Code Id : 12 Resident Certificate</h3>
                                        <div class="pull-right">
                                             <button class="btn btn-success closehideshow"
                                                  style="background-color:#00B050;">View Resident certificate Detail</button>
                                        </div>
                                   </div>
                                   <div class="panel-body">
                                        <div class="row">
											...
											<br>
											<h3 style="font-weight:bold;text-align:center;" id="0">-::रहिवासी प्रमाणपत्र::-</h3>
											<br>
                                              <!-- <form action="" class="form-horizontal" id="jvalidate" method="post" -->
                                                   <!-- accept-charset="utf-8"> -->
                                                <section class="resident" id="marathi" style="vertical-align:center;">
												<div class="row" style="padding-left:35px;">
												<div class="form-group">
                                                <div class="col-sm-3 text_notes1" id="2">प्रमाणित करण्यात येते की , श्री / श्रीमती</div>
												<div class="col-sm-2"> <input type="text" name="name" value="" id="name" placeholder="Name" class="form-control" required/></div>
												<div class="col-sm-2 text_notes1" id="3"> राहणार वार्ड क्र.</div>
												<div class="col-sm-2"> <input type="text" name="ward_no" value="" id="ward_no" placeholder="Ward No" class="form-control" required/></div>
												<div class="col-sm-3 text_notes1" id="4"> चंद्रपूर शहर महानगरपालिका / प्रभाग क्र.</div>
												</div>
												 </div>
												 &nbsp;
												 <div class="row">
												...
												<div class="col-sm-2 text_notes1" id="5">मध्ये मागील वर्षा </div>
												...
												<div class="col-sm-6 text_notes1" id="6"> पासुन राहत आहे . हे / ह्या चंद्रपूर शहर महानगरपालिका चे रहिवासी आहे . यांना मी ओळखतो.</div>
												 </div>
												 </div><br>
												 <div class="row" style="padding-left:35px;">
													<div class="col-sm-8 text_notes1" id="7">करीता प्रमाणपत्र देण्यात येत आहे.</div>
												 </div>
													 <br>
												 <br>
												 <br>
												 ...
												 <div class="col-sm-3" style="text-align:center;">
													<label id="11"><b style="center">मुख्याधिकारी</b></label><br>
													<label id="12">चंद्रपूर शहर महानगरपालिका</label>
												 </div>
												 </div>
													<br><br><br>
										<div style="margin-top:-15px;border-bottom:2px solid;width:100%;">
                                                ...
                                                <input type="hidden" id="save_update" value="" >
													<button class="btn btn-primary" id="submit" type="submit">Save</button>
                                                                 &nbsp;&nbsp;
                                                                      <?php if($this->session->role == "user"){?>
                                                                           <button class="btn btn-success" form="payment" id="pay" name="pay"value="Resident_Certificate"
												  ...
												  <form name="resident" id="resident" method="POST" action="<?php echo base_url('Pdf_print/print_resident');?>" target="_blank"></form>                             
												  <button class="btn btn-primary" type="submit" form="resident" id="btnprint" name="btnprint" value="" style="display:none">Print</button>
										 ...
										 <form name="property2" id="property2" method="POST" action="<?php echo base_url('Pdf_print/print_resident_marathi');?>" target="_blank"></form>
												</div>
	...
	<script src="<?php echo base_url(); ?>assets/js/myjs/resident.js"></script>
	<!--fileupload Files -->
	...
	<script>
		...
		$('#language').on('change',function(){
			...
			if(lan=='english'){
				newlabel = '-::Resident Certificate::-';
				newlabel1 = 'It is certifified that Mr./Smt';
				newlabel2 = 'Will stay on ward no.';
				newlabel3 = 'Chandrapur city municipality/ward no.';
				newlabel4 = 'In the Previous';
				newlabel5 = 'These is a living from rain.He/She is a resident of Chandrapur city municipality.I know that.';
				newlabel6 = 'Certificate is being issued for.';
				newlabel7 = 'Location:';
				newlabel8 = 'Chandrapur Municipal Corporation';
				newlabel9 = 'Date:';
				newlabel10 = 'Chief Officer';
				newlabel11 = 'Changrapur city municipality';
			}
			else{
				newlabel = '-::रहिवासी प्रमाणपत्र::-';
				newlabel1 = 'प्रमाणित करण्यात येते की , श्री / श्रीमती';
				newlabel2 = 'राहणार वार्ड क्र.';
				newlabel3 = 'चंद्रपूर शहर महानगरपालिका / प्रभाग क्र.';
				newlabel4 = 'मध्ये मागील वर्षा';
				newlabel5 = 'पासुन राहत आहे . हे / ह्या चंद्रपूर शहर महानगरपालिका चे रहिवासी आहे . यांना मी ओळखतो.';
				newlabel6 = 'करीता प्रमाणपत्र देण्यात येत आहे.';
				newlabel7 = 'स्थान:';
				newlabel8 = 'चंद्रपूर शहर महानगरपालिका';
				newlabel9 = 'दिनांक:';
				newlabel10 = 'मुख्याधिकारी';
				newlabel11 = 'चंद्रपूर शहर महानगरपालिका';
			}
			$('#0').html(newlabel);
			$('#2').html(newlabel1);
			$('#3').html(newlabel2);

...
<table width="100%">
	...
	<tr><td colspan="5" style="border-left: 2px solid rgb(0, 0, 0);border-right: 2px solid rgb(0, 0, 0);"></td></tr>
	...
	<tr><td colspan="5"  style="border-left: 2px solid rgb(0, 0, 0);border-right: 2px solid rgb(0, 0, 0);"><center>Receipt Voucher</center></td></tr>
	...
	<tr>
			...
			<td colspan = 5><br><br><br><br><br><br> </td></tr>

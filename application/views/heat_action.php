...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <!-- START BREADCRUMB -->
            <ul class="breadcrumb">
                <li class="active">Heat Action Plan</li>
            </ul>
            <!-- END BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Heat Action Plan</h3>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <label class="control-label">शिर्षक*</label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="शिर्षक" name="title_m" id="title_m" required>
                                            </div>
                                        </div>
                ...
                <div class="row ">
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Heat Action Plan Report</h3>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/heat_action.js"></script>
    <!--fileupload Files -->

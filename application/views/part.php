...
<body>
     ...
     <div class="page-container page-navigation-toggled page-container-wide">
          ...
          <div class="page-content">
               ...
               <!-- START BREADCRUMB -->
               <ul class="breadcrumb">
                    <li class="active">Part certificate</li>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                              ...
                              <div class="panel panel-default">
                                   <div class="panel-heading">
                                        <h3 class="panel-title">Code Id : 05 Part Certificate</h3>
                                       
                                        <ul class="panel-controls">

                                             <li> <button class="btn btn-success btnhideshow"
                                                       style="background-color:#00B050;"> Add Part certificate Detail</button></li>
                                        </ul>
                                   </div>
							...
							<h3 class="panel-title">Code Id : 05 Part Certificate</h3>
                                        <div class="pull-right">
                                             <button class="btn btn-success closehideshow"
                                                  style="background-color:#00B050;">View Part certificate Detail</button>
                                        </div>
                                   </div>
                                   <div class="panel-body">
                                        <div class="row">
											...
											<br>
											<h3 style="font-weight:bold;text-align:center;" id="0">-::भाग प्रमाणपत्र::-</h3>
											<br>
                                              <!-- <form action="" class="form-horizontal" id="jvalidate" method="post" -->
                                                   <!-- accept-charset="utf-8"> -->
                                                <section class="part" id="english" style="vertical-align:center;">
												...
												<div class="col-sm-3 text_notes" id="5">यांना भाग प्रमाणपत्र देण्यात येत आहे.</div>
												 </div>
												 </div>
													 <br>
												 <br>
										...
										<div style="margin-top:-15px;border-bottom:2px solid;width:100%;">
												...
												<br>
												 ...
												 <div class="col-sm-3">
													...
													<button class="btn btn-primary" id="submit" type="submit">Save</button>
                                                                 &nbsp;&nbsp;
                                                                      <?php if($this->session->role == "user"){?>
                                                                           <button class="btn btn-success" form="payment" id="pay" name="pay"value="Part_Certificate"
												  ...
												  <form name="part" id="part" method="POST" action="<?php echo base_url('Pdf_print/print_part');?>" target="_blank"></form>                             
												  <button class="btn btn-primary" type="submit" form="part" id="btnprint" name="btnprint" value=""style="display:none">Print</button>
										 ...
										 <form name="property2" id="property2" method="POST" action="<?php echo base_url('Pdf_print/print_part_marathi');?>" target="_blank"></form>
												</div>
	...
	<script src="<?php echo base_url(); ?>assets/js/myjs/part.js"></script>
	 <!--fileupload Files -->
	 ...
	 <script>
		...
		$('#language').on('change',function(){
			...
			if(lan=='english'){
				...
				newlabel4 = 'The certificate is being issued to them.';
				newlabel5 = 'Location:';

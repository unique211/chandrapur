...
/*function Header()
{
	...
	$this->Ln(20);
        ...
        foreach($record as $value){
            $id=$value->id;
            $name=$value->name;
            $word_no=$value->word_no;
            $municipality_word_no=$value->municipality_word_no;
            $year=$value->year;
            $date=$value->ndate;
        ...
        if($language=="english"){
            ...
            $table=new easyTable($pdf, '{120,120,120}', 'width:360; border-color:#000000; font-size:10; paddingY:2;');
    
           
            $table->easyCell("", 'font-style:B; colspan:2; font-size:10;');
            $table->easyCell("Number 3", 'font-style:B; align:C;  font-size:10;');
          
            $table->printRow();
    
          
            $table->easyCell("");
            $table->easyCell("-:: Resident Certificate ::-", ' align:C;  font-size:15;');
            $table->easyCell("");
            $table->printRow();
            $table->endTable(0);
            ...
            $table->easyCell("It is certified that Mr./Mrs <b>$name</b> will stay in the ward no. <b>$word_no</b> Chandrapur City Municipal Corporation/Ward No. <b>$municipality_word_no</b> live in the last <b>$year</b> years. He/She is a resident of Chandrapur city municipality. I know that.", ' align:L; colspan:3; font-size:10;');
           
            $table->printRow();
       
           
            $table->easyCell("Certificate is being issued for.", ' align:L; colspan:3; font-size:10;');

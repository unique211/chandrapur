...
/*function Header()
{
	...
	$this->Ln(20);
        ...
        if($language=="english"){
            ...
            $table->easyCell("-:: Construction Certificate ::-", ' align:C; colspan:2;  font-size:15;');
            $table->printRow();
            $table->endTable(0);
            ...
            $table->easyCell("" );
            $table->easyCell("It is certified that Mr. /Smt <b>$name</b> Will stay on word no. <b>$ward_no</b> Chandrapur city municipality / ward no. <b>$municipality_ward_no</b> These are given construction certificates.", ' align:L; colspan:2;  font-size:10;');

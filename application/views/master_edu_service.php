...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <!-- START BREADCRUMB -->
            <ul class="breadcrumb">
                <li class="active">Master of Educational Services</li>
            </ul>
            <!-- END BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Master of Educational Services</h3>
                                ...
                                <div class="row">
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="Service" name="title" id="title" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="control-label">Descrption*</label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="Descrption" name="news" id="news" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="सेवा" name="title_m" id="title_m" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="control-label">वर्णन*</label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="वर्णन" name="event" id="event" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="row ">
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Educational Services Report</h3>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/master_edu_service.js"></script>
    <!--fileupload Files -->

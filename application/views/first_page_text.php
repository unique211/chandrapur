...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <!-- START BREADCRUMB -->
            <ul class="breadcrumb">
                <li class="active">First page text</li>
            </ul>
            <!-- END BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">First page text</h3>
                                ...
                                <div class="row">
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-2">
                                                <label class="control-label">Name of the Tomb (in English)*</label>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" name="tomb" id="tomb" class="form-control" placeholder="Name of the Tomb (in English)" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <label class="control-label">टँबचे नाव (मराठी मध्ये)*</label>
                                            </div>
                                            <div class="col-md-4">
                                            <input type="text" name="tomb_m" id="tomb_m" class="form-control" placeholder="टँबचे नाव (मराठी मध्ये)" required>
                                            </div>
                ...
                <div class="row ">
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Report text on the first page</h3>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/first_page_text.js"></script>
    <!--fileupload Files -->

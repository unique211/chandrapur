...
foreach ($record as $value) {
	if($i==0)
		...
		$tamt = $tamt  + $value->payble_amt;
		$i++;
	

}
// echo 'challan _no '.$receipt_no;
// Concatenation Of String 
$receipt_no1 = $receipt_no." , <br/>".$receipt_no;
//	$receipt_no=$receipt_no1;
		...
		<center>
			<table width="95%" style="table-layout:initial;">
				...
				<tr>
					<td colspan=4 style="margin-top:-10%;font-size:14px;">
						<center>नमुना क्र . १३</center>
					</td>
					<td style="margin-top:-10%;font-size:14px;text-align:center;">
					<b><?php if(isset($this->session->zonename)){echo $this->session->zonename."  "; }if(isset($this->session->subzonename)){echo $this->session->subzonename;}?></b>
					</td>
				</tr>
...
//	$receipt_no=$receipt_no1;?>
	<?php	echo htmlentities($receipt_no);?> 
				...
				<tr>
					...
					<td class="allborder" colspan=2><?php echo $tamt;?></td>

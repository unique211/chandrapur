	...
	foreach ($record as $value) {
		...
		<table width="100%">
			...
			<tr class="allborder" style="font-size:13px;">
				...
				<td style="padding-left:1%;width:56%;" colspan=2 class="allborder">विवाह नोंदणी प्रमाणपत्राची सत्याप्रत</td>
			...
			<tr style="font-size:13px;">
				...
				<td colspan=5 style="padding-left:1%;" class="allborder">अक्षरी रुपये :- <?php echo $words;?> रोख मिठ्ठाले</td>

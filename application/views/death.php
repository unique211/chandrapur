                                    ...
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="applicant" name="applicant"
                                                        class="form-control" placeholder="अर्जदार " required>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label>पत्ता :*</label>
                                                </div>
                                                <div class="col-sm-3">
                                                    ...
                                                    <textarea rows="1" id="address" name="address" class="form-control"
                                                        style="height:34px;" placeholder="पत्ता" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="my_relation" name="my_relation"
                                                        class="form-control" placeholder="माझ्या" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="reg_no" name="reg_no" class="form-control"
                                                        placeholder="नोंदणी क्रमांक" required>
                                                </div>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="input-group date " data-provide="datepicker">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="reg_date" name="reg_date" autocomplete="off" required>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="name_deceased_m" name="name_deceased_m"
                                                        class="form-control" placeholder="मृतकाचे पूर्ण नाव" required>
                                                </div>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="name_deceased" name="name_deceased"
                                                        class="form-control" placeholder="Full Name of Deceased"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="deceased_name_husbund_m"
                                                        name="deceased_name_husbund_m" class="form-control"
                                                        placeholder="मृतकाचे वडील /पतीचे पूर्ण नाव" required>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label>Full name of Father / Husband of Deceased:*</label>
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text" id="deceased_name_husbund"
                                                        name="deceased_name_husbund" class="form-control"
                                                        placeholder="Full name of Father / Husband of Deceased"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="deceased_name_mother_m"
                                                        name="deceased_name_mother_m" class="form-control"
                                                        placeholder="मृतकाच्या आईचे नाव" required>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label>Full name of Mother of Deceased:*</label>
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text" id="deceased_name_mother"
                                                        name="deceased_name_mother" class="form-control"
                                                        placeholder="Full name of Mother of Deceased" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="input-group date " data-provide="datepicker">
                                                        ...
                                                        <input type="text"
                                                            class="form-control input-sm placeholdesize date1" id="dod"
                                                            name="dod" autocomplete="off" required>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="death_place_m" name="death_place_m"
                                                        class="form-control"
                                                        placeholder="मृत्यू ठिकाण(दवाखाना /घरी /इतर) " required>
                                                </div>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="death_place" name="death_place"
                                                        class="form-control"
                                                        placeholder="Place Of Death(Hospital /Home /Others) " required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <textarea rows="1" id="parmanent_address_deceased_m"
                                                        name="parmanent_address_deceased_m" class="form-control"
                                                        style="height:34px;"
                                                        placeholder="मृतकाचे राहण्याचा कायमचा पत्ता"
                                                        required></textarea>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <textarea rows="1" id="parmanent_address_deceased"
                                                        name="parmanent_address_deceased" class="form-control"
                                                        style="height:34px;" placeholder="Permanent address of Deceased"
                                                        required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <textarea rows="1" id="at_time_address_deceased_m"
                                                        name="at_time_address_deceased_m" class="form-control"
                                                        style="height:34px;" placeholder="मृतकाचे मृत्युसमयीचा पत्ता"
                                                        required></textarea>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <textarea rows="1" id="at_time_address_deceased"
                                                        name="at_time_address_deceased" class="form-control"
                                                        style="height:34px;"
                                                        placeholder="Address of Deceased at the time of death"
                                                        required></textarea>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="place_funeral_m" name="place_funeral_m"
                                                        class="form-control" placeholder="अंतिम संस्काराचे ठिकाण"
                                                        required>
                                                </div>
                                                <div class="col-sm-3">
                                        ...
                                        <div id="divToPrint">
                                            <center>
                                                <table frame="box" id="tbl_1"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td rowspan="2" style="width:20%;"><img
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="padding-bottom: 1%;padding-left: 17%;font-size:20px;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                ...
                                                <table frame="box" id="tbl_2" style="width:100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tbl_data mother_name_deceased_m"
                                                                id="mother_name_deceased_m"></td>
                                                            ...
                                                            <td class="tbl_data father_name_deceased_m"
                                                                id="father_name_deceased_m"></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tbl_data">
                                                                <font style="vertical-align: inherit;">

...
<body>
            ...
            <div class="page-content-wrap">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Title menu</h3>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <select class="form-control" id="parent_menu" name="parent_menu" required="">
                                                    ...
                                                    <option value="ADMINISTRATIVE_WING">
                                                        ADMINISTRATIVE WING
                                                    </option>
                                                    <option value="DELIBERATIVE_WING">
                                                        DELIBERATIVE WING
                                                    </option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <label class="control-label">Department (as needed)*</label>
                                            </div>
                                            <div class="col-md-3">
                                                <select name="dept" id="dept" class="form-control department" required>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="row ">
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Title Menu Report</h3>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/title_menu.js"></script>
    <!--fileupload Files -->

...
<div class="page-sidebar">
    ...
    <ul class="x-navigation">
        ...
        <li class="<?php if ($active_menu == 'ind') {
									echo 'x-active-nav';
								} ?>"><a href="<?php echo base_url() ?>Welcome/dashboard"><span class="fa fa-tachometer"></span> <span
...
<li class="<?php if($active_menu=='import'){	echo 'x-active-nav';	} ?>"><a href="<?php echo base_url() ?>Welcome/import"><span class="fa fa-file-excel-o"></span> <span class="xn-text">Import Data</span></a></li>
        ...
        <li class="<?php if ($active_menu == 'addadm') {
											echo 'x-active-nav';
										} ?>"><a href="<?php echo base_url() ?>Welcome/addadmin"><span class="fa fa-user"></span><span
                    class="xn-text">Add Admin</span></a>
        </li>
        <li class="<?php if ($active_menu == 'addstf') {
											echo 'x-active-nav';
										} ?>"><a href="<?php echo base_url() ?>Welcome/addstaff"><span class="fa fa-group"></span><span
                    class="xn-text">Add Staff Member</span></a>
        </li>
        ...
        <li class="<?php if ($active_menu == 'feestr') {
											echo 'x-active-nav';
										} ?>"><a href="<?php echo base_url() ?>Welcome/fee_structure"><span class="fa fa-money"></span><span
                    class="xn-text">Fee Structure</span></a>
        </li>
        ...
        <li class="<?php if ($active_menu == 'pro') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/property_record"><span
                    class="fa fa-exchange"></span><span class="xn-text">Property Transfer Record</span></a></li>
        <li class="<?php if ($active_menu == 'inh') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/inheritance"><span class="fa fa-user"></span><span
                    class="xn-text">Inheritance Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'fir_o') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/firefinal_object"><span
                    class="fa fa-fire"></span><span class="xn-text">Fire Fighting Final No Objection
                    Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'occ') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/occupation"><span
                    class="fa fa-briefcase"></span><span class="xn-text">Occupation Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'part') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/part"><span class="fa fa-plus"></span><span
                    class="xn-text">Part Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'zone') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/zone"><span class="fa fa-map-marker"></span><span
                    class="xn-text">Zone Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'con') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/construction"><span
                    class="fa fa-wrench"></span><span class="xn-text">Construction Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'plant') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/plant"><span class="fa fa-plus"></span><span
                    class="xn-text">Plant Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'fir_f') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/fire_fighting"><span
                    class="glyphicon glyphicon-fire"></span><span class="xn-text">Fire fighting</span></a></li>
        <li class="<?php if ($active_menu == 'out') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/outstanding"><span
                    class="fa fa-tachometer"></span><span class="xn-text">Outstanding Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'no_ob') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/no_objection"><span
                    class="fa fa-bullseye"></span><span class="xn-text">No Objection Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'res') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/resident"><span class="fa fa-home"></span><span
                    class="xn-text">Resident Certificate</span></a></li>
        <li class="<?php if ($active_menu == 'ass') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/asset_detail"><span
                    class="fa fa-tachometer"></span><span class="xn-text">Asset Detail Certificate</span></a></li>
        ...
        <li class="<?php if ($active_menu == 'bir') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/birth_death"><span
                    class="fa fa-calendar"></span><span class="xn-text">Birth</span></a>
        </li>
        <li class="<?php if ($active_menu == 'death') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/death"><span class="fa fa-calendar"></span><span
                    class="xn-text">Death</span></a>
        </li>
        <li class="openable open ">
            ...
            <ul class="submenu">
                <li class="<?php if ($active_menu == 'mar') {
													echo 'x-active-nav';
												} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/marriage_registration"><span
                            class="submenu-label">Marriage Registration</span></a>
                </li>
                <li class="<?php if ($active_menu == 'cash_rv') {
													echo 'x-active-nav';
												} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/cash_counter_receipt_voucher"><span
                            class="submenu-label">Cash Counter Receipt Voucher</span></a>
                </li>
                <li class="<?php if ($active_menu == 'cash_rv') {
													echo 'x-active-nav';
												} ?>"><a class="" target="_blank" href="<?php echo base_url(); ?>Marrige/showDatewiseReceipt"><span
                            class="submenu-label">Generate Challan</span></a>
                </li>
            </ul>
        </li>
        ...
        <li class="openable open ">
            ...
            <ul class="submenu">
                ...
                <li class="<?php if ($active_menu == 'cash_rv') {
													echo 'x-active-nav';
												} ?>"><a class="" target="_blank" href="<?php echo base_url(); ?>CashCounter/showDatewiseReceipt"><span
                            class="submenu-label">Generate Challan</span></a>
                </li>
            </ul>
        </li>
        ...
        <li class="<?php if ($active_menu == 'miscellaneous') {
											echo 'x-active-nav';
										} ?>"><a class="" href="<?php echo base_url(); ?>Welcome/miscellaneous_cash_counter"><span
                    class="fa fa-money"></span><span class="xn-text">Miscellaneous Cash Counter</span></a></li>
        ...
        <li class="openable open ">
            ...
            <ul class="submenu">
                ...
                <li class="<?php if ($active_menu == 'suggestions') {
													echo 'x-active-nav';
												} ?>"><a href="<?php echo base_url(); ?>Welcome/suggestions"><span
                            class="submenu-label">Suggestions</span></a>
                </li>
                ...
                <li class="<?php if ($active_menu == 'admin_staff_profile') {
													echo 'x-active-nav';
												} ?>"><a href="<?php echo base_url(); ?>Welcome/admin_staff_profile"><span
                            class="submenu-label">Administrative Wing</span></a>
                </li>
                ...
                <li class="<?php if ($active_menu == 'frequiently_ask_questions') {
													...
													echo 'x-active-nav';
												} ?>"><a href="<?php echo base_url(); ?>Welcome/frequiently_ask_questions"><span
                            class="submenu-label">Frequently Asked Questions</span></a>
                </li>
            </ul>
        </li>

                                    ...
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="applicant_name" name="applicant_name"
                                                        class="form-control" placeholder="Applicant's Name" required>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label>Applicant's Mobile Number*</label>
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="number" style="text-align:right;" id="applicant_mno"
                                                        name="applicant_mno" class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="number" value="2016" style="text-align:right;"
                                                        id="reg_year" name="reg_year" class="form-control"
                                                        placeholder="Applicant's Mobile number" required>
                                                </div>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="register_no" name="register_no"
                                                        class="form-control" placeholder="Register No" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group date " data-provide="datepicker">
                                                    <input type="text"
                                                        class="form-control input-sm placeholdesize date1" id="reg_date"
                                                        name="reg_date" autocomplete="off">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group date " data-provide="datepicker">
                                                    <input type="text"
                                                        class="form-control input-sm placeholdesize date1" id="date"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" id="birth_place2" name="birth_place2"
                                                    class="form-control" placeholder="Birth Place" required>
                                            </div>
                                            <!-- <div class="col-sm-3"> -->
                                            <!-- <label>Birth Address</label> -->
                                            <!-- </div> -->
                                            ...
                                            <!-- </div> -->
                                            <div class="col-sm-3">
                                                <label>जन्मठिकाण :</label>
                                            </div>
                                            <div class="col-sm-3">
                                                <input type="text" id="birth_place2_m" name="birth_place2_m"
                                                    class="form-control" placeholder="जन्मठिकाण" required>
                                            </div>
                                        </div>
                                    </div><br>
                                    <!-- <div class="row"> -->
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" id="child_name_m" name="child_name_m"
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check form-check-inline ">
                                                    <input class="form-check-input" type="radio" name="gender_m"
                                                        id="men_m" value="पुरुष">पुरुष
                                                    <input class="form-check-input" type="radio" name="gender_m"
                                                        id="woman_m" value="स्त्री">स्त्री
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" id="father_name_m" name="father_name_m"
                                                    class="form-control" placeholder="वडिलांचे पूर्ण नाव" required>
                                            </div>
                                        </div>
                                    </div><br>
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" id="mother_name_m" name="mother_name_m"
                                                    class="form-control" placeholder="आईचे पूर्ण नाव" required>
                                            </div>
                                        </div>
                                    </div><br>
                                    <!-- <div class="row"> -->
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <!-- </div> -->
                                            <div class="col-sm-3">
                                                <label>Address of Parents at the time of child birth</label>
                                            </div>
                                            <div class="col-sm-3">
                                                <textarea rows="1" id="Parent_Address_Time_of_Birth"
                                                    name="Parent_Address_Time_of_Birth" class="form-control"
                                                    style="height:34px;"
                                                    placeholder="Address of Parents at the time of child birth"></textarea>
                                            </div>
                                            <div class="col-sm-3">
                                                <label>बाळाचे जन्मावेळी आई - वडिलांचा पत्ता :</label>
                                            </div>
                                            <div class="col-sm-3">
                                                <textarea rows="1" id="Parent_Address_Time_of_Birth_m"
                                                    name="Parent_Address_Time_of_Birth_m" class="form-control"
                                                    style="height:34px;"
                                                    placeholder="बाळाचे जन्मावेळी आई - वडिलांचा पत्ता"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <label>आई - वडिलांचा कायमचा पत्ता :</label>
                                            </div>
                                            <div class="col-sm-3">
                                                <textarea rows="1" id="parent_permanet_address_m"
                                                    name="parent_permanet_address_m" class="form-control"
                                                    style="height:34px;"
                                                    placeholder="आई - वडिलांचा कायमचा पत्ता"></textarea>
                                            </div>
                                            <!-- <div class="col-sm-3"> -->
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <textarea rows="1" id="additional_remark" name="additional_remark"
                                                    class="form-control" style="height:34px;"
                                            ...
                                            <div class="col-sm-3">
                                                <textarea rows="1" id="additional_remark_m" name="additional_remark_m"
                                                    class="form-control" style="height:34px;"
                                                    placeholder="शेरा"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group date " data-provide="datepicker">
                                                    <input type="text"
                                                        class="form-control input-sm placeholdesize date1"
                                                        id="issue_date" name="issue_date" autocomplete="off" required>
                                                    <div class="input-group-addon">
                                                        <span class="fa fa-calendar"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <table id="dataTable" class="table table-striped table-bordered">
                                                ...
                                                <tbody id="issuetbody">
                                                    <tr>
                                                        <td>1</td>
                                                        <td>ID Proof*</td>
                                                        <td align="center"><input type="checkbox" name="chk_id_proof"
                                                                id="chk_id_proof">
                                                        </td>
                                                        <td align="center"> <input type="file" id="attachment1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"><input type="checkbox"
                                                                ...
                                                                id="chk_cer_delivery"><br><br><input type="checkbox"
                                                                name="chk_affidavit" id="chk_affidavit"></td>
                                                        <td align="center"><input type="file" id="attachment2"
                                                                name="attachment2" accept="*"
                                                                style="padding:0px;border:0; display:none;">
                                                            <input type="hidden" id="file_attachother2"
                                                                class="file_attachother2" value="" />
                                                            <div id="msg2" class="msg2"></div><br><input type="file"
                                                                id="attachment3" name="attachment3" accept="*"
                                                                style="padding:0px;border:0;display:none;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"><input type="checkbox" name="chk_noc"
                                                                id="chk_noc"><br><br><input type="checkbox"
                                                                name="chk_court_reg" id="chk_court_reg"><br><br><input
                                                                type="checkbox" name="chk_order" id="chk_order"></td>
                                                        <td align="center"><input type="file" id="attachment4"
                                                                name="attachment4" accept="*"
                                                                style="padding:0px;border:0;display:none;">
                                                            <input type="hidden" id="file_attachother4"
                                                                class="file_attachother4" value="" />
                                                            <div id="msg4" class="msg4"></div><br><input type="file"
                                                                id="attachment5" name="attachment5" accept="*"
                                                                style="padding:0px;border:0;display:none;">
                                                            <input type="hidden" id="file_attachother5"
                                                                class="file_attachother1" value="" />
                                                            <div id="msg5" class="msg5"></div><br><input type="file"
                                                                id="attachment6" name="attachment6" accept="*"
                                                                style="padding:0px;border:0;display:none;">
                                    ...
                                    <form class="form-horizontal" id="master_form3" name="master_form3">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="registration_no3" name="registration_no3"
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="number" style="text-align:right;" id="applicant_mno3"
                                                        name="applicant_mno3" class="form-control"
                                                        placeholder="Applicant's Mobile number" required disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="input-group date " data-provide="datepicker" required>
                                                        <input type="text"
                                                            class="form-control input-sm placeholdesize date1"
                                                            id="appo_date" autocomplete="off" name="appo_date" required>
                                                        <div class="input-group-addon">
                                                            <span class="fa fa-calendar"></span>
                                                        </div>
                                                    </div>
                                    ...
                                    <form class="form-horizontal" id="master_form4" name="master_form4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="name_child2" name="name_child2"
                                                        class="form-control" placeholder="बाळाचे नाव" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="name_mother1" name="name_mother1"
                                                        class="form-control" placeholder="Name of Mother" required
                                                        disabled>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label>आईचे पूर्ण नाव*</label>
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="name_mother2" name="name_mother2"
                                                        class="form-control" placeholder="आईचे पूर्ण नाव" required
                                                        disabled>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="name_father1" name="name_father1"
                                                        class="form-control" placeholder="Name of Father" required
                                                        disabled>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label>वडिलांचे पूर्ण नाव*</label>
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="name_father2" name="name_father2"
                                                        class="form-control" placeholder="वडिलांचे पूर्ण नाव" required
                                                        disabled>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <textarea id="address_app1" name="address_app1" class="form-control"
                                                        placeholder="Address of Parent" required></textarea>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label>पालकांचा कायमचा पत्ता*</label>
                                                </div>
                                                <div class="col-sm-3">
                                                    <textarea id="address_app2" name="address_app2" class="form-control"
                                                        placeholder="पालकांचा कायमचा पत्ता" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="birth_place1" name="birth_place1"
                                                        class="form-control" placeholder="Birth place" required
                                                        disabled>
                                                </div>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" id="birth_place11" name="birth_place11"
                                                        class="form-control" placeholder="जन्म स्थान" required disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="input-group date " data-provide="datepicker" required>
                                                        <input type="text"
                                                            class="form-control input-sm placeholdesize date1"
                                                            id="app_dob" autocomplete="off" name="app_dob" disabled>
                                                        <div class="input-group-addon">
                                                            <span class="fa fa-calendar"></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-check form-check-inline ">
                                                        <div class="col-sm-1">
                                                            <input class="form-check-input" type="radio"
                                                                name="redio_app" id="men_app" value="men"></div>
                                                        <div class="col-sm-2" style="margin-left:-2%;">
                                                            <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <div class="col-sm-1">
                                                            <input class="form-check-input" type="radio"
                                                                name="redio_app" id="woman_app" value="woman"></div>
                                                        <div class="col-sm-1" style="margin-left:-2%;">
                                            ...
                                            <center>
                                                <table frame="box" id="tbl_1"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="padding-bottom: 1%;padding-left: 17px;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                ...
                                <div class="col-lg-12">
                                    <form class="form-horizontal" id="master_form5" name="master_form5">
                                        <div id="divToPrint">
                                            <center>
                                                <table frame="box" id="tbl_1"
                                                    style="margin-top: 1%;width:100%;height:111px;padding-left:2%;padding-right:2%;">
                                                    <tbody>
                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <center>
                                                                                    <img src="<?php echo base_url(); ?>images/satya.jpg"
                                                                                        style="float: left;padding-left: 20%;width: 35%;height:85px;">
                                                                                </center>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                    ...
                                                                    <table>
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>
                                                                                    <center><b
                                                                                            style="font-size: 15px;">महाराष्ट्र
                                                                                            शासन</b></center>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <center><b
                                                                                            style="font-size: 15px;">Government
                                                                            ...
                                                                            <td>
                                                                                <center>
                                                                                    <img src="<?php echo base_url(); ?>images/cmc.jpg"
                                                                                        style="float: left;padding-left: 1%;width: 70%;height:105px;">
                                                                                </center>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="padding-bottom:2%;">
                                                            <td colspan="4" style="text-align:justify;font-size:11px;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        ( जन्म व मृत्यू नोंदणी अधिनियम, १९६९ च्या कलम
                                                                        १२/१७ आणि महाराष्ट्र जन्म आणि मृत्यू नोंदणी
                                                                        नियम, २००० चे नियम ८/१३ अन्वये देण्यात आले आहे.
                                                                        )
                                                                    </font>
                                                                </font>
                                                            </td>
                                                        ...
                                                        <tr style="padding-bottom:2%;">
                                                            <td colspan="4" style="text-align:justify;font-size:11px;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        ( Issued undersection 12/17 of the Registration
                                                                        of Births & Deaths Act, 1969 and Rule 8/13 of
                                                                        the Maharashtra Registraion of Births and Deaths
                                                                        Rules, 2000. )
                                                                    </font>
                                                                </font>
                                                            </td>
                                                        ...
                                                        <tr style="padding-bottom:2%;">
                                                            <td colspan="4" style="text-align:justify;font-size:11px;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        प्रमाणित करण्यात येते की, खालील माहिती जन्माच्या
                                                                        मूळ अभिलेखाच्या नोंदवहीतून घेण्यात आली आहे, जी
                                                                        की चंद्रपूर शहर महानगरपालिका, तालुका चंद्रपूर,
                                                                        जिल्हा चंद्रपूर, महाराष्ट्र राज्याच्या नोंदवहीत
                                                                        उल्लेख आहे.
                                                                    </font>
                                                                </font>
                                                            </td>
                                                            ...
                                                            <td colspan="4" style="text-align:justify;font-size:11px;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        ...
                                                                        record of birth which is the register for
                                                                        Chandrapur City Municipal Corporation,
                                                                        Chandrapur of Tahsil / Chadrapur of District
                                                                        Chandrapur of Maharashtra State.
                                                                    </font>
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr style="font-size:12px;">
                                                            ...
                                                            <td class="tbl_data " id="b_regdate1">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="child_name_m"></label></font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" style="width:20%;">
                                                                <font style="vertical-align: inherit;">
                                                        ...
                                                        <tr style="font-size:12px;">
                                                            ...
                                                            <td class="tbl_data " id="b_regdate1">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="child_name"></label></font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" style="width:20%;">
                                                                <font style="vertical-align: inherit;">
                                                        ...
                                                        <tr style="font-size:12px;">
                                                            ...
                                                            <td class="tbl_data" id="b_regno1">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="date_of_birth"></label></font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" style="width:20%;">
                                                                <font style="vertical-align: inherit;">
                                                            ...
                                                            <td class="tbl_data" id="b_regdate1">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="birth_place_m"></label></font>
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr style="font-size:12px;">
                                                            ...
                                                            <td class="tbl_data" id="b_regdate1">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="birth_place"></label></font>
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr style="font-size:12px;">
                                                            <td class="tbl_data" style="width:20%;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        बाळाचे जन्मावेळी <br> आई - वडिलांचा पत्ता :
                                                                    </font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" id="b_dob1">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="address_at_birth_m"></label>
                                                                    </font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" style="width:20%;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        आई - वडिलांचा <br> कायमचा पत्ता :</font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" id="b_dob1">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="perminent_address_m"></label>
                                                                    </font>
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr style="font-size:12px;">
                                                            <td class="tbl_data" style="width:20%;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        Address of Parents at <br> the time of child
                                                                        birth:</font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" id="b_dob1">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="address_at_birth"></label></font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" style="width:20%;">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        Permanent address <br> of Parents:</font>
                                                                </font>
                                                            </td>
                                                            <td class="tbl_data" id="b_dob1">
                                                                <font style="vertical-align: inherit;">
                                                        ...
                                                        <tr style="font-size:12px;">
                                                            ...
                                                            <td class="tbl_data" id="b_dob1" colspan="3">
                                                                <font style="vertical-align: inherit;">
                                                                    <font style="vertical-align: inherit;">
                                                                        <label class="remarks_m"></label>&nbsp;<label
                                                                            class="remarks"></label></font>
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr style="font-size:12px;text-align:left;">
                                                            <td class="tbl_data" colspan="1" rowspan="3"
                                                                style="vertical-align:top;">
                                                                <center>
                                                                    <font style="vertical-align: inherit;">
                                                                        <font style="vertical-align: inherit;">
                                                                            जन्म व मृत्यू विभाग, चंशमनपा, चंद्रपूर
                                                                        </font>
                                                                    </font>
                                                                </center>
                                                            </td>

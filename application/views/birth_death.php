...
<body>
									...
									<form class="form-horizontal" id="master_form" name="master_form">
										<div class="row">
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" id="applicant_name" name="applicant_name" class="form-control" placeholder="Applicant's Name" required>
												</div>
												<div class="col-sm-3">
													<label>Applicant's Mobile Number*</label>
												</div>
												<div class="col-sm-3">
													<input type="number" style="text-align:right;" id="applicant_mno" name="applicant_mno" class="form-control" placeholder="Applicant's Mobile number" required>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="number" value="2016" style="text-align:right;" id="reg_year" name="reg_year" class="form-control" placeholder="Applicant's Mobile number" required>
												</div>
												<div class="col-sm-3">
													<label>Register No.*</label>
												</div>
												<div class="col-sm-3">
													<input type="text" id="register_no" name="register_no" class="form-control" placeholder="Register No" required>
												</div>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" id="page_no" name="page_no" class="form-control" placeholder="Page No">
												</div>
											</div>
										</div>
								</div>
								...
								<div class="col-lg-12">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<div class="input-group date " data-provide="datepicker">
													<input type="text" class="form-control input-sm placeholdesize date1" id="reg_date" name="reg_date" autocomplete="off">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" id="birth_place2" name="birth_place2" class="form-control" placeholder="Birth Place" required>
											</div>
											<!-- <div class="col-sm-3"> -->
											<!-- <label>Birth Address</label> -->
											<!-- </div> -->
											...
											<div class="col-sm-3">
												<input type="text" id="birth_place2_m" name="birth_place2_m" class="form-control" placeholder="जन्मठिकाण" required>
											</div>
										</div>
									</div><br>
									<!-- <div class="row"> -->
								...
								<div class="col-lg-12">
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" id="child_name" name="child_name" class="form-control" placeholder="Child Name">
											</div>
											<!-- <div class="col-sm-3"> -->
											...
											<div class="col-sm-3">
												<input type="text" id="child_name_m" name="child_name_m" class="form-control" placeholder="बाळाचे नाव">
											</div>
										</div>
									</div><br>
									<div class="row">
								...
								<div class="col-lg-12">
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" id="father_name_m" name="father_name_m" class="form-control" placeholder="वडिलांचे पूर्ण नाव" required>
											</div>
										</div>
									</div><br>
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" id="mother_name_m" name="mother_name_m" class="form-control" placeholder="आईचे पूर्ण नाव" required>
											</div>
										</div>
									</div><br>
									<!-- <div class="row"> -->
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<textarea rows="1" id="Parent_Address_Time_of_Birth" name="Parent_Address_Time_of_Birth" class="form-control" style="height:34px;" placeholder="Address of Parents at the time of child birth"></textarea>
											</div>
											<div class="col-sm-3">
												<label>बाळाचे जन्मावेळी आई - वडिलांचा पत्ता :</label>
											</div>
											<div class="col-sm-3">
												<textarea rows="1" id="Parent_Address_Time_of_Birth_m" name="Parent_Address_Time_of_Birth_m" class="form-control" style="height:34px;" placeholder="बाळाचे जन्मावेळी आई - वडिलांचा पत्ता"></textarea>
											</div>
										</div>
									</div>
									<br>
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<textarea rows="1" id="parent_permanet_address" name="parent_permanet_address" class="form-control" style="height:34px;" placeholder="Parent permanent Address"></textarea>
											</div>
											<div class="col-sm-3">
												<label>आई - वडिलांचा कायमचा पत्ता :</label>
											</div>
											<div class="col-sm-3">
												<textarea rows="1" id="parent_permanet_address_m" name="parent_permanet_address_m" class="form-control" style="height:34px;" placeholder="आई - वडिलांचा कायमचा पत्ता"></textarea>
											</div>
											<!-- <div class="col-sm-3"> -->
								...
								<div class="col-lg-12">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<textarea rows="1" id="additional_remark" name="additional_remark" class="form-control" style="height:34px;" placeholder="Remarks"></textarea>
											</div>
											<div class="col-sm-3">
												<label>शेरा</label>
											</div>
											<div class="col-sm-3">
												<textarea rows="1" id="additional_remark_m" name="additional_remark_m" class="form-control" style="height:34px;" placeholder="शेरा"></textarea>
											</div>
										</div>
									</div>
									<br>
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<div class="input-group date " data-provide="datepicker">
													<input type="text" class="form-control input-sm placeholdesize date1" id="issue_date" name="issue_date" autocomplete="off" required>
													<div class="input-group-addon">
														<span class="fa fa-calendar"></span>
													</div>
												</div>
							...
							<div class="panel-body">
								<div class="col-lg-12">
									<form class="form-horizontal" id="master_form5" name="master_form5">
										<div id="divToPrint_form_5">
											<center>
												<table frame="box" id="tbl_1" style="margin-top: 1%;width:100%;height:111px">
													<tbody>
														<tr>
															<td rowspan="2" style="width:46%;"><img src="<?php echo base_url(); ?>images/cmc.jpg" style="margin-left: 5%;height: 88px;">
															</td>
												...
												<table frame="box" id="tbl_2" style="width:100%">
													<tbody>
														...
														<tr>
															...
															<td class="tbl_data" id="ac_reg_no_m">
															...
															<td class="tbl_data" id="ac_reg_date_m">
														...
														<tr>
															...
															<td class="tbl_data" id="ac_reg_no"></td>
															<td class="tbl_data">
																<font style="vertical-align: inherit;">
																	<font style="vertical-align: inherit;">
															...
															<td class="tbl_data" id="ac_reg_date">
														...
														<tr>
															...
															<td class="tbl_data" id="ac_child_name_m"></td>
															<td class="tbl_data">
																<font style="vertical-align: inherit;">
																	<font style="vertical-align: inherit;">
																		लिंग :</font>
															...
															<td class="tbl_data" id="ac_gender_m">
														...
														<tr>
															...
															<td class="tbl_data" id="ac_child_name"></td>
															<td class="tbl_data">
																<font style="vertical-align: inherit;">
																	<font style="vertical-align: inherit;">
																		Gender:</font>
															...
															<td class="tbl_data" id="ac_gender">
														...
														<tr>
															...
															<td class="tbl_data" id="ac_placeofbirth_m"></td>
														</tr>
														<tr>
															<td class="tbl_data">
																<font style="vertical-align: inherit;">
															...
															<td class="tbl_data" id="ac_placeofbirth"></td>
														</tr>
														<tr>
															<td colspan="4">&nbsp;</td>
														</tr>
														<tr>
															...
															<td class="tbl_data" id="ac_mother_name_m"></td>
															<td class="tbl_data">
																<font style="vertical-align: inherit;">
																	<font style="vertical-align: inherit;">
															...
															<td class="tbl_data" id="ac_father_name_m"></td>
														</tr>
														<tr>
															<td class="tbl_data">
																<font style="vertical-align: inherit;">
															...
															<td class="tbl_data" id="ac_mother_name"></td>
															<td class="tbl_data">
																<font style="vertical-align: inherit;">
																	<font style="vertical-align: inherit;">
																		Name of Father:</font>
															...
															<td class="tbl_data" id="ac_father_name"></td>
														</tr>
														<tr>
															<td colspan="4">&nbsp;</td>
														</tr>
														...
														<tr>
															...
															<td class="tbl_data" id="ac_date_of_issue_m">
																<?php
														...
														<tr>
															...
															<!--<td class="tbl_data">0000-00-00</td>-->
															<td class="tbl_data" id="ac_date_of_issue">
	...
	<script>
		...
		$('a.printPage2').click(function() {
			var divToPrint = document.getElementById("divToPrint_form_5");
			newWin = window.open("");
			newWin.document.write(divToPrint.outerHTML);
			newWin.print();
			newWin.close();

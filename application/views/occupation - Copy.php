                                   ...
                                   <div class="panel-heading">
                                        ...
                                        <ul class="panel-controls">
                                             ...
                                             <li> <button class="btn btn-success btnhideshow"
                                                       style="background-color:#00B050;"> Add Occupation certificate Detail</button></li>
                                        </ul>
                                   </div>
							...
							<h3 class="panel-title">Code Id : 04 Occupation Certificate</h3>
                                        <div class="pull-right">
                                             <button class="btn btn-success closehideshow"
                                                  style="background-color:#00B050;">View Occupation certificate Detail</button>
                                        </div>
                                   </div>
                                   <div class="panel-body">
                                        <div class="row">
											...
											<br>
											<h3 style="font-weight:bold;text-align:center;" id="0">-::भोगवटा उतारा::-</h3>
											<br>
                                              <!-- <form action="" class="form-horizontal" id="jvalidate" method="post" -->
                                                   <!-- accept-charset="utf-8"> -->
                                                <section class="occupation" id="english" style="vertical-align:center;">
                                               
												<div class="row" style="padding-left:35px;">
												<div class="form-group">
                                                <div class="col-sm-3 text_notes" id="1">प्रमाणित करण्यात येते की , श्री / श्रीमती</div>
												...
												<div class="col-sm-2 text_notes" id="5"> मागील मध्ये</div>
												<div class="col-sm-2"> <input type="text" name="year" value="" id="year" placeholder="Year" class="form-control" required/></div>
												<div class="col-sm-4 text_notes" id="6"> प्रमाणित करण्यात येते की , श्री / श्रीमती राहणार वार्ड क्र.</div>
												 </div>
												 </div>
												 &nbsp;
												 <div class="row">
													<div class="col-sm-8 text_notes" id="7"> चंद्रपूर शहर महानगरपालिका / प्रभाग क्र. यांना भोगवटा प्रमाणपत्र देण्यात येत आहे.</div>
												 </div>
													 <br>
												 <br>
												 <br>
												 ...
												 <div class="col-sm-3" style="text-align:center;">
													<label id="11"><b style="center" >आयुक्त</b></label><br>
										...
										<div style="margin-top:-15px;border-bottom:2px solid;width:100%;">
												...
												<br>
												 ...
												 <div class="col-sm-3">
													...
													<button class="btn btn-primary" id="submit" type="submit">Save</button>
                                                                 &nbsp;&nbsp;
                                                                      <?php if($this->session->role == "user"){?>
                                                                           <button class="btn btn-success" form="payment" id="pay" name="pay"value="Occupation_Certificate"
												  ...
												  <form name="occuption" id="occuption" method="POST" action="<?php echo base_url('Pdf_print/print_occuption');?>" target="_blank"></form>                             
												 <button class="btn btn-primary" type="submit" form="occuption" id="btnprint" name="btnprint" value=""style="display:none">Print</button>
										 ...
										 <form name="property2" id="property2" method="POST" action="<?php echo base_url('Pdf_print/print_occuption_marathi');?>" target="_blank"></form>
												  </div>
	 ...
	 <script src="<?php echo base_url().'assets/js/AjaxFileUpload.js'?>"></script>
	  <script>
		...
		$('#language').on('change',function(){
			...
			if(lan=='english'){
				newlabel = '-::Warsaw Rights Certificate::-';
				newlabel1 = 'It is certifified that Mr./Smt';
				newlabel2 = 'Will stay on ward no.';
				newlabel3 = 'Chandrapur city municipal Corporation/ward no.';
				newlabel4 = 'In the previous';
				newlabel5 = 'Their is a living from rain. He/she is a resident of';
				newlabel6 = 'Chandrapur city municipality. I know that. Occupation certificate is being issued.';
				newlabel7 = 'Location:';
				newlabel8 = 'Chandrapur Municipal Corporation';
				newlabel9 = 'Date:';
				newlabel10 = 'Commissioner';
				newlabel11 = 'Changrapur city municipality';
			}
			else{
				newlabel = '-::भोगवटा उतारा::-';
				newlabel1 = 'प्रमाणित करण्यात येते की , श्री / श्रीमती';
				newlabel2 = 'राहणार वार्ड क्र.';
				newlabel3 = 'चंद्रपूर शहर महानगरपालिका / प्रभाग क्र.';
				newlabel4 = 'मागील मध्ये';
				newlabel5 = 'प्रमाणित करण्यात येते की , श्री / श्रीमती राहणार वार्ड क्र.';
				newlabel6 = 'चंद्रपूर शहर महानगरपालिका / प्रभाग क्र. यांना भोगवटा प्रमाणपत्र देण्यात येत आहे.';
				newlabel7 = 'स्थान:';

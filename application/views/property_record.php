...
<body>
    ...
    <div class="page-container page-navigation-toggled page-container-wide">
        ...
        <div class="page-content">
            ...
            <!-- START BREADCRUMB -->
            <ul class="breadcrumb">
                <li class="active">Property Transfer Record</li>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Code Id : 01 Property Transfer Record</h3>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <br>
                                    <h3 style="font-weight:bold;text-align:center;" id="0">-::मालमत्ता
                                        हस्तांतरण नोंद::-</h3>
                                    <input type="hidden" id="srno" value="">
                                    <br>
                                    <!-- <form action="" class="form-horizontal" id="jvalidate" method="post" -->
                                    <!-- accept-charset="utf-8"> -->
                                    <section class="property_transfer" id="english" style="vertical-align:center;">
                                        <div class="row" style="padding-left:35px;">
                                            <div class="form-group">
                                                <div class="col-sm-3 text_notes" id="15">प्रमाणित करण्यात
                                                    येते की , श्री / श्रीमती</div>
                                                <div class="col-sm-2"> <input type="text" name="name" value="" id="name"
                                                        placeholder="Name" class="form-control" required /></div>
                                                <div class="col-sm-2 text_notes" id="3">राहणार वार्ड क्र.
                                                </div>
                                                <div class="col-sm-2"> <input type="text" name="ward_no" value=""
                                                        id="ward_no" placeholder="Ward No" class="form-control"
                                                        required /></div>
                                                <div class="col-sm-3 text_notes" id="14"> चंद्रपूर शहर
                                                    महानगरपालिका / प्रभाग क्र.</div>
                                            </div>
                                        </div>
                                        &nbsp;
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-sm-2"> <input type="text" name="munici_ward_no" value=""
                                                        id="munici_ward_no" placeholder="municipality/ward no."
                                                        class="form-control" required /></div>
                                                <div class="col-sm-2 text_notes" id="5">मालमत्ता क्र.</div>
                                                <div class="col-sm-2"> <input type="text" name="property_no" value=""
                                                        id="property_no" placeholder="Property no." class="form-control"
                                                        required /></div>
                                                <div class="col-sm-3 text_notes" id="6">यांची मालमत्ता
                                                    हस्तांतरण नोंद करण्यात येत आहे.</div>
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3" style="text-align:center;">
                                                <label id="10"><b style="center">मुख्याधिकारी</b></label><br>
                                                <label id="11">चंद्रपूर शहर महानगरपालिका</label>
                                            </div>
                                        </div>
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="hidden" id="file_attachother"
                                                                class="file_attachother" value="" />
                                                            <div id="msg" class="msg"></div>
                                                        </td>
                                                        <td>
                                                            <input name="remark" type="text" class="form-control"
                                                                id="remark" placeholder="Remarks" value="">
                                                        </td>
                                                        <td><button type="button" class="btn btn-primary btn-xs plus "
                                                                form="pro_form" id="plus"><i
                                        ...
                                        <div class="row center">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="btn-group " style="float:right;">
                                                    ...
                                                    <button class="btn btn-success" form="payment" id="pay" name="pay"
                                                        value="Property_Transfer_Record" type="submit">Pay
                                                        Online</button>
                                            ...
                                            <div class="col-sm-6" style="margin-left:-1%;">
                                                ...
                                                <form name="property" id="property" method="POST"
                                                    action="<?php echo base_url('Pdf_print/print_property'); ?>"
                                                    target="_blank"></form>

                                                <button class="btn btn-primary" type="submit" form="property"
                                                    id="btnprint" name="btnprint" value="" style="display:none">Print
                                                </button>

                                                <button class="btn btn-primary" type="submit" id="btnprint2"
                                                    form="property2" name="btnprint2" value=""
                                                    style="display:none">Print </button>
                                                <form name="property2" id="property2" method="POST"
                                                    action="<?php echo base_url('Pdf_print/print_property_marathi'); ?>"
                                                    target="_blank"></form>
                                            </div>
                                                ...
                                                <form id="reject_form" name="reject_form">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger"
                                                            data-dismiss="modal" id="close_model">Close</button>
                                                        <input type="submit" class="btn btn-success">
                                                    </div>
                                                </form>
                                            </div>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/property_record.js"></script>
    ...
    $('#language').on('change', function() {
        ...
        if (lan == 'english') {
            newlabel = '-::Property Transfer Note::-';
            newlabel1 = 'It is certifified that Mr./Smt';
            newlabel2 = 'Will stay on ward no.';
            newlabel3 = 'Chandrapur city municipality/ward no.';
            newlabel4 = 'Property No.';
            newlabel5 = 'Their Property tranfer is being recorded.';
            newlabel6 = 'Location:';
            newlabel7 = 'Chandrapur Municipal Corporation';
            newlabel8 = 'Date:';
            newlabel9 = 'Chief Officer';
            newlabel10 = 'Changrapur city municipality';
        } else {
            newlabel = '-::मालमत्ता हस्तांतरण नोंद::-';
     ...
     newlabel3 = 'चंद्रपूर शहर महानगरपालिका / प्रभाग क्र.';
            newlabel4 = 'मालमत्ता क्र.';
            newlabel5 = 'यांची मालमत्ता हस्तांतरण नोंद करण्यात येत आहे.';
            newlabel6 = 'स्थान:';
            newlabel7 = 'चंद्रपूर शहर महानगरपालिका';
            newlabel8 = 'दिनांक:';
            newlabel9 = 'मुख्याधिकारी';
            newlabel10 = 'चंद्रपूर शहर महानगरपालिका';
        }
        $('#0').html(newlabel);
        $('#15').html(newlabel1);
        $('#3').html(newlabel2);

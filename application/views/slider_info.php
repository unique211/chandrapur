...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <!-- START BREADCRUMB -->
            <ul class="breadcrumb">
                <li class="active">Slider info</li>
            </ul>
            <!-- END BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                                ...
                                <div class="row">
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="Slider Description" name="slider_desc" id="slider_desc" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="control-label">स्लायडर माहिती*</label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="स्लायडर माहिती" name="slider_info" id="slider_info" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="Sort" name="sort" id="sort" required>
                                            </div>
                                            <div class="col-sm-3">
                ...
                <div class="row ">
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Slider Info Report</h3>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/slider_info.js"></script>
    <!--fileupload Files -->

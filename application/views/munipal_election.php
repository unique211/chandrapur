...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <!-- START BREADCRUMB -->
            <ul class="breadcrumb">
                <li class="active">Municipal Election 5 Events</li>
            </ul>
            <!-- END BREADCRUMB -->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Municipal Election 5 Events</h3>
                                ...
                                <div class="row">
                                    <form class="form-horizontal" id="master_form" name="master_form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="News Descrption" name="news" id="news" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="घडामोडीचे वर्णन" name="event" id="event" required>
                                            </div>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/municipal_election.js"></script>
    <!--fileupload Files -->

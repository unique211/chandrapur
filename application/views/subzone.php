                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                              ...
                              <div class="panel panel-default">
                                   ...
                                   <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Add Subzone Form</h3>
                                   ...
                                   <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" id="master_form" name="master_form">
												...
												<div class="form-group">
                                                       ...
                                                       <select class="form-control zone" style="width:100%;" name="zone" id="zone" required>
                                    ...
                                    <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <label class="control-label" >Subzone*</label>

                                                </div>

                                                <div class="col-md-3">

                                                <input type="text" placeholder="Subzone" class="form-control input-sm placeholdesize" id="subzone" name="subzone" required >
...
<div class="col-md-12 col-sm-12 col-xs-12 right_side">
     ...
     <div class="panel panel-default">
          ...
          <div class="panel-heading">
               ...
               <h3 class="panel-title"> Sub Zone</h3>
...
<!--NEWS SECTION END-->
     ...
     <script src="<?php echo base_url(); ?>assets/js/myjs/subzone.js"></script>

...
<body>
            ...
            <div class="page-content-wrap">
                ...
                <div class="row  formhideshow" style="display:none">
                    <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Department Form</h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" placeholder="Department"
                                                    class="form-control input-sm placeholdesize" id="department"
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" placeholder="Department Code"
                                                    class="form-control input-sm placeholdesize" id="department_code"
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/adddepartment.js"></script>

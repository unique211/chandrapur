     ...
     <div class="page-container page-navigation-toggled page-container-wide">
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12 right_side">
                              ...
                              <div class="panel panel-default">
                                   ...
                                   <h3 class="panel-title">Code Id : 15 Marriage Certificate Registration</h3>
                                        ...
                                        <li>   <form name="challan" id="challan" method="POST"
                                             ...
                                             <button class="btn btn-info"  type="submit" form="challan"
                                                              ...
                                                              name="getDatewiseReceiptbtn" 

                                        id="getDatewiseReceiptbtn" value="">Generate Challan</button></li>
												...
												<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-3">
                                                            ...
                                                            <input type="number" style="text-align:right;"
                                                                 ...
                                                                 id="groom_contact_no" name="groom_contact_no"

                                                                 class="form-control" placeholder="Groom Contact No."
                                                       ...
                                                       <div class="col-sm-3">
                                                            ...
                                                            <input type="text" id="bride_contact_no"

                                                                 name="bride_contact_no" class="form-control"

                                                                 placeholder="Bride Contact No." required>
												...
												<div class="col-lg-6">
													...
													<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <textarea id="g_address" name="g_address"

                                                                 class="form-control" style="height:34px;"

                                                                 placeholder="Groom Name" required></textarea>
													...
													<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="groom_tahsil" name="groom_tahsil"
                                                                 ...
                                                                 class="form-control" placeholder="Groom Tahsil"
													...
													<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="groom_dist" name="groom_dist"
                                                                 ...
                                                                 class="form-control" placeholder="Groom District"
													...
													<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="bride_previousname"

                                                                 name="bride_previousname" class="form-control"

                                                                 placeholder="Bride Previous Name" required>
													...
													<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <textarea id="bride_previousnadd" style="height:34px;"
                                                                 ...
                                                                 placeholder="Bride Previous Address"
													...
													<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="bride_previoustahsil"

                                                                 name="bride_previoustahsil" class="form-control"

                                                                 placeholder="Bride Previous Tahsil" required>
													...
													<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="bride_previousdist"

                                                                 name="bride_previousdist" class="form-control"

                                                                 placeholder="Bride Previous District" required>
													...
													<div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <textarea id="marriage_add" style="height:34px;"

                                                                 name="marriage_add" class="form-control"

                                                                 placeholder="Marriage Address" required></textarea>
                                             ...
                                             <div class="col-lg-6">
                                                  ...
                                                  <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <textarea id="c_address" name="c_address"

                                                                 style="height:34px;" class="form-control"

                                                                 placeholder="पतीचा पत्ता" required></textarea>
                                                  ...
                                                  <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="child_tahsil" name="child_tahsil"
                                                                 ...
                                                                 class="form-control" placeholder="पतीचा तहसिल"
                                                  ...
                                                  <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="child_dist" name="child_dist"
                                                                 ...
                                                                 class="form-control" placeholder="पतीचा जिल्हा"
                                                  ...
                                                  <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="girl_previousname"

                                                                 name="girl_previousname" class="form-control"

                                                                 placeholder="पत्नीचे नाव" required>
                                                  ...
                                                  <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="girl_previoustahsil"

                                                                 name="girl_previoustahsil" class="form-control"

                                                                 placeholder="पत्नीचा  तहसिल" required>
                                                  ...
                                                  <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <input type="text" id="girl_previousdist"

                                                                 name="girl_previousdist" class="form-control"

                                                                 placeholder="पत्नीचा  जिल्हा" required>
                                                  ...
                                                  <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-6">
                                                            ...
                                                            <textarea id="wedding_add" style="height:34px;"

                                                                 name="wedding_add" class="form-control"

                                                                 placeholder="विवाह पत्ता" required></textarea>
                                                       ...
                                                       <div class="col-sm-3">
                                                            ...
                                                            <!-- <div class="input-group date " data-provide="datepicker"> -->
                                                                 ...
                                                                 <input type="text"
                                                                      ...
                                                                      id="date_of_marrige" name="date_of_marrige"

                                                                      autocomplete="off" required placeholder="DD/MM/YYYY">
                                                       ...
                                                       <div class="col-sm-3">
                                                            ...
                                                            <!-- <div class="input-group date " data-provide="datepicker"> -->
                                                                 ...
                                                                 <input type="text"
                                                                      ...
                                                                      id="c_birth_date" name="c_birth_date"
                                                       ...
                                                       <div class="col-sm-3">
                                                            ...
                                                            <!-- <div class="input-group date " data-provide="datepicker"> -->
                                                                 ...
                                                                 <input type="text"
                                                                      ...
                                                                      id="g_birth_date" name="g_birth_date"
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-sm-3">
                                                            ...
                                                            <input type="number" style="text-align:right;"
                                                                 ...
                                                                 id="child_age" name="child_age" class="form-control"

                                                                 placeholder="Child's age" required disabled>
                                                       ...
                                                       <div class="col-sm-3">
                                                            ...
                                                            <input type="number" style="text-align:right;" id="girl_age"
                                                                 ...
                                                                 name="girl_age" class="form-control"

                                                                 placeholder="Girl's age" required disabled>
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                 ...
                                                                 <input type="text" id="boy_name" name="boy_name"
                                                                      ...
                                                                      class="form-control" placeholder="मुलाचे नाव"
                                                            ...
                                                            <div class="col-sm-4">
                                                                 ...
                                                                 <input type="text" id="girl_name" name="girl_name"
                                                                      ...
                                                                      class="form-control" placeholder="मुलीचे नाव"
                                                            ...
                                                            <tbody id="issuetbody">
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                name="checkbox" id="ch_1"></td>

                                                                      <td><input type="file" id="attachment1"

                                                                                name="attachment1" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                name="checkbox" id="ch_2"></td>

                                                                      <td><input type="file" id="attachment2"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                id="ch_3_1"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_3_2"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_3_3"></td>

                                                                      <td><input type="file" id="attachment3_1"

                                                                                name="attachment3_1" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                id="ch_4_1"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_4_2"></td>

                                                                      <td><input type="file" id="attachment4_1"

                                                                                name="attachment4_1" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                name="checkbox" id="ch_5"></td>

                                                                      <td><input type="file" id="attachment5"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                id="ch_6_1"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_6_2"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_6_3"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_6_4"></td>

                                                                      <td><input type="file" id="attachment6_1"

                                                                                name="attachment6_1" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                id="ch_7_1"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_7_2"></td>

                                                                      <td><input type="file" id="attachment7_1"

                                                                                name="attachment7_1" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                id="ch_8_1"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_8_2"></td>

                                                                      <td><input type="file" id="attachment8_1"

                                                                                name="attachment8_1" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                name="checkbox" id="ch_9"></td>

                                                                      <td><input type="file" id="attachment9"

                                                                                name="attachment9" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                name="checkbox" id="ch_10"></td>

                                                                      <td><input type="file" id="attachment10"

                                                                                name="attachment10" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                name="checkbox" id="ch_11"></td>

                                                                      <td><input type="file" id="attachment11"

                                                                                name="attachment11" accept="*"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td align="center"><input type="checkbox"
                                                                                ...
                                                                                id="ch_12_1"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_12_2"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_12_3"><br><br><input

                                                                                type="checkbox" name="checkbox"

                                                                                id="ch_12_4"></td>

                                                                      <td><input type="file" id="attachment12_1"

                                                                                name="attachment12_1" accept="*"

                                                                                style="padding:0px;border:0; display:none;">

                                                                           <input type="hidden"

                                                                                id="file_attachother12_1"
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="number" style="text-align:right;"
                                                                      ...
                                                                      id="groom_mno" name="groom_mno" disabled
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="number" style="text-align:right;"
                                                                      ...
                                                                      id="bride_mno" name="bride_mno" disabled
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <div class="input-group date "
                                                                      ...
                                                                      data-provide="datepicker" required disabled>
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="wedding_place" rows="1"

                                                                      name="wedding_place" class="form-control"

                                                                      placeholder="विवाहाचे ठिकाण" disabled
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="various_personal"

                                                                      style="width: 408px; height: 33px;" rows="1"

                                                                      name="various_personal" class="form-control"
                                             ...
                                             <form class="form-horizontal" id="master_form" name="master_form">
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="husbund_name"

                                                                      name="husbund_name" class="form-control"

                                                                      placeholder="पतीचे नाव" required disabled>
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="address_business" rows="1"

                                                                      name="address_business" class="form-control"

                                                                      placeholder="आणि कार्यालयाचा पत्ता"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
															...
															<select id="another_religion"

                                                                      name="another_religion"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="g_age_executed"

                                                                      name="g_age_executed" class="form-control"
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="address_full" rows="1"

                                                                      name="address_full" class="form-control"

                                                                      placeholder="पतीचा पुर्ण पत्ता"
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="wife_name" name="wife_name"
                                                                      ...
                                                                      class="form-control" placeholder="पत्नीचे नाव"
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="wife_name_second"

                                                                      name="wife_name_second" class="form-control"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="waddress_business" rows="1"

                                                                      name="waddress_business" class="form-control"
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <select id="w_religion" name="w_religion"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
																...
																<select id="wanother_religion"

                                                                      name="wanother_religion"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="b_age_executed"

                                                                      name="b_age_executed" class="form-control"
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="w_address_full" rows="1"

                                                                      name="w_address_full" class="form-control"

                                                                      placeholder="पत्नीचा पुर्ण पत्ता"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="w1_name" name="w1_name"

                                                                      class="form-control" placeholder="नाव" required>
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="w1_address" rows="1" name="w1_address"
                                                                      ...
                                                                      class="form-control" placeholder=" पत्ता"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="w1address_business" rows="1"

                                                                      name="w1address_business" class="form-control"

                                                                      placeholder="व्यवसाय आणि कार्यालयाचा पत्ता"
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="relationship_couple1"
                                                                      ...
                                                                      placeholder="विवाहित जोडप्याशी असलेले नाते"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="w2_name" name="w2_name"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="w2address_business" rows="1"

                                                                      name="w2address_business" class="form-control"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="w3_name" name="w3_name"
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="w3address_business" rows="1"

                                                                      name="w3address_business" class="form-control"
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="priest_name" name="priest_name"
                                                                      ...
                                                                      class="form-control" placeholder="पुरोहिताचे नाव"
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <textarea id="address" rows="1" name="address"

                                                                      class="form-control" placeholder="पुर्ण पत्ता"
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="text" id="age" name="age"
                                                                      ...
                                                                      class="form-control" placeholder="वय" required>
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-sm-2">
                                                                 ...
                                                                 <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile51" name="uploadFile51"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother51" value=""
                                                            ...
                                                            <div class="col-sm-2">
                                                                 ...
                                                                 <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile52" name="uploadFile52"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother52" value=""
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile53" name="uploadFile53"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother53" value=""
                                                            ...
                                                            <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile54" name="uploadFile54"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother54" value=""
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile55" name="uploadFile55"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother55" value=""
                                                            ...
                                                            <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile56" name="uploadFile56"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother56" value=""
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile57" name="uploadFile57"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother57" value=""
                                                            ...
                                                            <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile58" name="uploadFile58"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother58" value=""
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile59" name="uploadFile59"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother59" value=""
                                                            ...
                                                            <input type="file" class="form-control input-md"
                                                                      ...
                                                                      id="uploadFile591" name="uploadFile591"

                                                                      accept="image/*">

                                                                 <input type="hidden" id="file_attachother591" value=""
                              ...
                              <div class="panel-body">
								...
								<table frame="box" id="tbl_2" style="width:100%">
									...
									<tbody><tr>
										...
										<th colspan="4" style="padding-top: 1%;"><center><b>  विवाह नोंदणी कर्यालय ,  चंद्रपूर शहर महानगरपालिका   </b></center></th>

									</tr>

									<tr>

										<td colspan="4"><center><b> - आदेश पत्र - </b></center></td>

									</tr>

									<tr>

										<th colspan="4" style="padding-top: 1%;padding-left: 1%;"><center>-------------------------------------विवाह नोंदणी करणे बाबत -----------------------------------------------	</center> </th>
      ...
      त्यांनी विवाह नोंदणी करून प्रमाण पत्राची मागणी केली असून त्यांना विवाह प्रमाणपत्र देण्यास हरकत नाही. तरी डि फार्म व  विवाह नोंदणी प्रमाणपत्र आपल्या स्वाक्षरीस सदर
									...
									<tr>
										...
										<td colspan="4" style="padding-top: 1%;"><center>निबंधक, विवाह नोंदणी , चंद्रपूर शहर महानगरपालिका  -----------------------------------</center></td>
                                   ...
                                   <center>
                                             ...
                                             <font style="vertical-align: inherit;">
                                                  ...
                                                  <font style="vertical-align: inherit;"> <a
                                                            ...
                                                            class="printPage1 btn btn-primary" href="#">Print</a></font>
                      ...
                      <!-- <div><span>Reference No : <strong>CMC</strong></span></div> -->
						...
						<table frame="box" id="tbl_2" style="width:100%;margin-top:2%;border: 4px solid;">
							...
							<tbody><tr>
								...
								<td style="width:20%;padding-top: 1%;padding-left: 2%;">

									<table style="width:100%;">

										<tbody><tr>

											<td style="float: left;padding-left: 2%;width: 80%;height:147px;">
								...
								<td style="width:40%;">
									...
									<table>
										...
										<tbody><tr>
											...
											<td><center><b style="font-size: 23px;">  Chandrapur City Municipal Corporation </b></center></td>
										...
										<tr>
											...
											<td><center><b style="font-size: 20px;">Marriage Registration</b></center></td>
										...
										<tr>
											...
											<td><center><b>Sample 'E'</b></center></td>

										</tr>

										<tr>

											<td><center><b>Marriage Registration Certificate</b></center></td>

										</tr>

										<tr>

											<td><center><b> (See section 6 (1) and Rule 5)  </b></center></td>
...
2019/000784 on date   12/06/2019 I was registered on my behalf. 
								...
								<td colspan="3"> 
									...
									<table style="float: right; margin-right: 75px;">
										...
										<tbody><tr>
											...
											<td style="padding-top: 2%;"><center><b>Registrar</b></center></td>

										</tr>

										<tr>

											<td style="padding-top: 2%;"><center><b>Marriage Registration Officer,</b></center></td>

										</tr>

										<tr>

											<td style="padding-top: 2%;"><center><b>Chandrapur City Municipal Corporation.</b></center></td>

										</tr>

										<tr>

											<td style="padding-top: 2%;"><center><img alt="" src="http://allysoftsolutions.com/chandrapur/images/barcode.png"><br>2019MCMC14163</center></td>
                      ...
                      <!-- <div><span>Reference No : <strong>CMC</strong></span></div> -->
						...
						<table frame="box" id="tbl_2" style="width:100%;margin-top:2%;border: 4px solid;">
								...
								<table style="width:100%;">
										...
										<tbody>
											...
											<center>
                                                       ...
                                                       <img  src="<?php echo base_url(); ?>images/cmc.jpg" style="float: left;padding-left: 1%;width: 75%;height:115px;"> 
										...
										<tr style="margin-top:5%;">
											...
											<img  class="hphoto" src="<?php echo base_url(); ?>images/cmc.jpg" style="float: left;padding-left: 1%;width: 75%;height:115px;border: 1px solid;"> 
								...
								<center style="margin-top:15%;">
									...
									<table>
										...
										<tbody><tr>
											...
											<td><center><b style="font-size: 25px;">  चंद्रपूर शहर महानगरपालिका   </b></center></td>
										...
										<tr>
											...
											<td><center><b style="font-size: 20px;">  विवाह नोंदणी कर्यालय   </b></center></td>
										...
										<tr>
											...
											<td><center><b style="font-size: 15px;line-height:2;"> नमुना 'इ '    </b></center></td>

										</tr>

										<tr>

											<td><center><b style="font-size: 15px;line-height:2;">  विवाह नोंदणीचे प्रमाणपत्र   </b></center></td>

										</tr>

										<tr>

											<td><center><b style="font-size: 15px;line-height:2;"> (पहा कलम ६(१) आणि नियम ५)  </b></center></td>
								...
								<td style="width:20%;">
									...
									<table style="width:100%;">
										...
										<tbody>
											...
											<center style="float: left;padding-left: 1%;width: 65%;height:95px;">
										...
										<tr style="margin-top:5%;">
											...
											<img   class="gphoto" src="<?php echo base_url(); ?>images/cmc.jpg" style="float: left;padding-left: 1%;width: 75%;height:115px;border: 1px solid;"> 

											<div style="width: 49%;font-size: 14px;margin-left: -55px;">
							...
							<table style="width: 100%; border-bottom: 2px dotted gray;padding-top:1%;"> <tr><td></td></tr></table>
								...
								<td colspan="3"> 
									...
									<table style="float: right; margin-right: 15px;">
										...
										<tbody><tr>
											...
											<td style="padding-top: 2%;"><center><b> निबंधक </b></center></td>

										</tr>

										<tr>

											<td style="padding-top: 2%;"><center><b> विवाह नोंदणी अधिकारी ,  </b></center></td>

										</tr>

										<tr>

											<td style="padding-top: 2%;"><center><b> चंद्रपूर शहर महानगरपालिका.  </b></center></td>
										...
										<tr>
											...
											<td style="padding-top: 1%;"><center><b><label class="mr_receipt"></label></b></center></td>
                      ...
                      <!-- <div><span>Reference No : <strong>CMC</strong></span></div> -->
						...
						<table frame="box" id="tbl_2" style="width:100%;margin-top:2%;border: 4px solid;">
								...
								<td style="width:40%;" colspan="4">
									...
									<table>
										...
										<tbody><tr>
											...
											<td><center><b style="font-size: 18px;">  विवाह नोंदणी कर्यालय, चंद्रपूर शहर महानगरपालिका   </b></center></td>

										</tr>

										<tr>

											<td><center><b style="font-size: 15px;"> नमुना 'इ '  </b></center></td>

										</tr>

										<tr>

											<td><center><b style="font-size: 15px;">  विवाह नोंदणीचे प्रमाणपत्र   </b></center></td>

										</tr>

										<tr>

											<td><center><b style="font-size: 15px;"> (गोषवारा भाग १)  </b></center></td>
							...
							<table style="width: 100%; border-bottom: 2px dotted;padding-top:1%;margin-bottom:1%;"> <tr><td></td></tr></table>
                           ...
                           <tr><td colspan="4">
							...
							<table style="width: 100%; border-bottom: 2px dotted gray;"> <tr><td></td></tr></table>
                           ...
                           <tr><td colspan="4">&nbsp;</td></tr>
							...
							<tr colspan="4" style="font-size:14px;">
								...
								<td style="width:42%;" colspan="2"><center>वराची माहिती</center></td>

								<td><center>छायाचित्र</center></td>

								<td><center>अंगठ्याचा ठसा</center></td>
								...
								<td colspan="4">
									...
									<table style="width:100%;">
										...
										<tr style="font-size:14px;">
											...
											<td style="width:25%"><center><img alt="" class="hphoto" width="130px" height="130px" src="<?php echo base_url(); ?>images/barcode.png"></center></td>

											<td style="width:25%"><center><img alt="" class="htphoto"  width="130px" height="130px"  src="<?php echo base_url(); ?>images/barcode.png"></center></td>
							...
							<tr colspan="4" style="font-size:14px;">
								...
								<td style="width:42%;" colspan="2"><center>वधूची माहिती</center></td>
								...
								<td colspan="4">
									...
									<table style="width:100%;">
										...
										<tr style="font-size:14px;">
											...
											<td style="width:25%"><center><img alt="" class="gphoto" width="130px" height="130px" src="<?php echo base_url(); ?>images/barcode.png"></center></td>

											<td style="width:25%"><center><img alt="" class="gtphoto"  width="130px" height="130px"  src="<?php echo base_url(); ?>images/barcode.png"></center></td>
								...
								<td colspan="4"> 
									...
									<table style="float: right; margin-right: 75px; font-size:18px;">
										...
										<tbody><tr>
											...
											<td style="padding-top: 1%;"><center><b> निबंधक </b></center></td>

										</tr>

										<tr>

											<td style="padding-top: 1%;"><center><b> विवाह नोंदणी अधिकारी ,  </b></center></td>

										</tr>

										<tr>

											<td style="padding-top: 1%;"><center><b> चंद्रपूर शहर महानगरपालिका.  </b></center></td>
                      ...
                      <!-- <div><span>Reference No : <strong>CMC</strong></span></div> -->
						...
						<table frame="box" id="tbl_2" style="width:100%;margin-top:2%;border: 4px solid;">
								...
								<td style="width:40%;" colspan="4">
									...
									<table>
										...
										<tr>
											...
											<td><center><b style="font-size: 15px;"> (गोषवारा भाग २)  </b></center></td>
							...
							<table style="width: 100%;padding-top:1%; border-bottom: 2px dotted gray;margin-bottom:1%;"> <tr><td></td></tr></table>
							...
							<table style="width: 100%;padding-top:1%; border-bottom: 2px dotted gray;"> <tr><td></td></tr></table>
                            ...
                            <tr style="font-size:14px;">
								...
								<td rowspan="3" style="width:25%"><center><img class='sphoto1' width="130px" height="130px" alt="" src="<?php echo base_url(); ?>images/barcode.png"></center></td>

								<td rowspan="3" style="width:25%"><center><img class='stphoto1' width="130px" height="130px" alt="" src="<?php echo base_url(); ?>images/barcode.png"></center></td>
							...
							<tr style="font-size:14px;">
								...
								<td rowspan="3" style="width:25%"><center><img class='sphoto2' width="130px" height="130px" alt="" src="<?php echo base_url(); ?>images/barcode.png"></center></td>

								<td rowspan="3" style="width:25%"><center><img class='stphoto2' width="130px" height="130px" alt="" src="<?php echo base_url(); ?>images/barcode.png"></center></td>
							...
							<tr style="font-size:14px;">
								...
								<td rowspan="3" style="width:25%"><center><img class='sphoto3' width="130px" height="130px"  alt="" src="<?php echo base_url(); ?>images/barcode.png"></center></td>

								<td rowspan="3" style="width:25%"><center><img class='stphoto3' width="130px" height="130px" alt="" src="<?php echo base_url(); ?>images/barcode.png"></center></td>
								...
								<td colspan="4"> 
									...
									<table style="float: right; margin-right: 75px; font-size:16px;">
										...
										<tbody><tr>
											...
											<td><center><b> निबंधक </b></center></td>
                      ...
                      <!-- <div><span>Reference No : <strong>CMC</strong></span></div> -->
						...
						<table frame="box" id="tbl_2" style="width:100%;margin-top:1%;border: 4px solid;">
									...
									<table style="width:100%;">
										...
										<tbody>
											...
											<center>
                                                       ...
                                                       <img src="<?php echo base_url(); ?>images/satya.jpg" style="float: left;padding-left: 20%;width: 30%;height:75px;"> 
								...
								<td style="width:40%;">
									...
									<table>
										...
										<tbody>
											...
											<td><center><b style="font-size: 19px;">महाराष्ट्र शासन</b></center></td>

										</tr>

                                                       <tr>

											<td><center><b style="font-size: 19px;">Government of Maharashtra</b></center></td>

										</tr>

                                                       <tr>

											<td><center><b style="font-size: 19px;">  चंद्रपूर शहर महानगरपालिका   </b></center></td>

										</tr>

                                                       <tr>

											<td><center><b style="font-size: 19px;">  Chandrapur City Municipal Corporation   </b></center></td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><center><b> नमुना "ई"  </b></center></td>

                                                       </tr>

                                                       <tr>

                                                            <td><center><b> Form “E”  </b></center></td>

                                                       </tr>

                                                       <tr>

											<td><center><b>  विवाह नोंदणीचे प्रमाणपत्र   </b></center></td>

										</tr>

                                                       <tr>

											<td><center><b>  Certificate of Registration of Marriage   </b></center></td>

										</tr>

										<tr>

											<td><center><b> (कलम ६ (१) आणि नियम ५)  </b></center></td>
							...
							<tr>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;यांचा विवाह दिनांक <label class="m_date"></label>  रोजी  <label class="m_address"></label> &nbsp; येथे संपन्न झाला. त्याची महाराष्ट्र विवाह मंडळाचे विनियमन आणि विवाह नोंदणी विधेयक १९९८ अन्वये ठेवण्यात आलेल्या नोंद वहीच्या खंड क्रमांक ५४ च्या अनुक्रमांक एम ए एच एम / सी एन डी / २०१९ /<label class="mr_reg"></label> वर दिनांक <label class='current_date_print'></label> रोजी मी नोंदणी केली आहे.
							...
							<tr>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Solemnized on dated <label class="m_date"></label> at <label class="me_address"></label> (Place) is registered by me on date <label class='current_date_print'></label> at serial No. MAHM/ CND / 2019 / <label class="mr_reg"></label> of Volume  no. 54 of register of Marriages maintained under the Maharashtra Regulation of Marriage bureau and Registration of Marriage Act 1998.
							...
							<tr>
								...
								<td style="padding-left: 1%;"><center><b><label class="mr_receipt"></label></b></center></td>

								<td style="text-align:right;padding-right: 9%;"  colspan="2">चंद्रपूर शहर महानगरपालिका</td>
                                   ...
                                   <center>
                                             ...
                                             <font style="vertical-align: inherit;">
                                                  ...
                                                  <font style="vertical-align: inherit;"><a
                                                            ...
                                                            class="printPage2 btn btn-primary" href="#">Print</a></font>
                                                       ...
                                                       <table id="dataTable" class="table table-striped table-bordered">
                                                            ...
                                                            <tbody id="issuetbody">
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td><input type="file" id="attachment9_1"

                                                                                name="attachment9_1" accept="*"
                                                                           ...
                                                                           <div id="msg9_1" class="msg9_1"></div></td>

                                                                      <td><input type="text" class="form-control"

                                                                                id="order_latter" name="order_latter"

                                                                                placeholder="आदेश पत्र"required></td>
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td><input type="file" id="attachment9_2"

                                                                                name="attachment9_2" accept="*"
                                                                           ...
                                                                           <div id="msg9_2" class="msg9_2"></div></td>

                                                                      <td><input type="text" class="form-control"

                                                                                id="sample_e_marathi"

                                                                                name="sample_e_marathi"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td><input type="file" id="attachment9_3"

                                                                                name="attachment9_3" accept="*"
                                                                           ...
                                                                           <div id="msg9_3" class="msg9_3"></div></td>

                                                                      <td><input type="text" class="form-control"

                                                                                id="sample_e_english"

                                                                                name="sample_e_english"
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td><input type="file" id="attachment9_4"

                                                                                name="attachment9_4" accept="*"
                                                                           ...
                                                                           <div id="msg9_4" class="msg9_4"></div></td>

                                                                      <td><input type="text" class="form-control"

                                                                                id="abstract_1" name="abstract_1"

                                                                                placeholder="गोषवारा भाग १"required></td>
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td><input type="file" id="attachment9_5"

                                                                                name="attachment9_5" accept="*"
                                                                           ...
                                                                           <div id="msg9_5" class="msg9_5"></div></td>

                                                                      <td><input type="text" class="form-control"

                                                                                id="abstract_2" name="abstract_2"

                                                                                placeholder="गोषवारा भाग २" required></td>
													   ...
													   <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                 ...
                                                                 <input type="number" style="text-align:right;" id="no_copies"
                                                                      ...
                                                                      name="no_copies" class="form-control"

                                                                      placeholder="No of Copies" required>

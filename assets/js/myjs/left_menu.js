$(document).ready(function() {
    ...
    function datashow() {
        $.ajax({
            type: "POST",
            url: baseurl + "Left_menu/showdata",
            data: {
                table_name: table_name,
            },
            dataType: "JSON",
            ...
            success: function(data) {
                ...
                html += '<table id="myTable" class="table table-striped">' +
                    ...
                    '<th style="display:none;"><font style="font-weight:bold">Sort</font></th>' +
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    html += '<tr>' +
                        ...
                        '<td style="display:none;" id="sort_' + data[i].id + '">' + data[i].sort + '</td>' +
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        url: baseurl + "Left_menu/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,

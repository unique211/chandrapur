$(document).ready(function() {
    ...
    function datashow() {
        $.ajax({
            type: "POST",
            url: baseurl + "E_tenders/showdata",
            data: {
                table_name: table_name,
            },
            dataType: "JSON",
            ...
            success: function(data) {
                ...
                html += '<table id="myTable" class="table table-striped">' +
                    ...
                    '<th ><font style="font-weight:bold">E-Tender Descrption</font></th>' +
                    '<th ><font style="font-weight:bold">ई-निविदेच वर्णन</font></th>' +
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    html += '<tr>' +
                        ...
                        '<td  id="title_' + data[i].id + '">' + data[i].desc + '</td>' +
                        '<td  id="title_m_' + data[i].id + '">' + data[i].desc_m + '</td>' +
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        url: baseurl + "E_tenders/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'E_tenders/doc_image_upload',

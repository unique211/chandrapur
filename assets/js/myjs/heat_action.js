$(document).ready(function() {
    var table_name = "heat_action_plan";
    $(document).on("submit", "#master_form", function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Heat_action/adddata",
            data: {
                id: id,
                parent: parent,
                desc: desc,
    ...
    function datashow() {
        $.ajax({
            type: "POST",
            url: baseurl + "Heat_action/showdata",
            data: {
                table_name: table_name,
            },
            dataType: "JSON",
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        url: baseurl + "Heat_action/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'Heat_action/doc_image_upload',

$(document).ready(function() {
    var table_name = "about_muni_corp";
    $(document).on("submit", "#master_form", function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "About_muni_corp/adddata",
            data: {
                id: id,
                file: file,
                desc: desc,
    ...
    function datashow() {
        $.ajax({
            type: "POST",
            url: baseurl + "About_muni_corp/showdata",
            data: {
                table_name: table_name,
            },
            dataType: "JSON",
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        url: baseurl + "About_muni_corp/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'About_muni_corp/doc_image_upload',

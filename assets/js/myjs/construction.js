$(document).ready(function() {
    ...
    function get_appmaxid() {
        $.ajax({
            type: "POST",
            url: baseurl + "Constrct/selectmaxid",
            dataType: "JSON",
            async: false,
            data: {
            ...
            success: function(data) {
                ...
                if (r != 0 || r != "0") {
                    for (var i = 0; i < r; i++) {
                        ...
                        var certificate_type = "construction";
                        //  table_name = "doc_upload";

                        //  alert(ref_id);
                        $.ajax({
                            type: "POST",
                            url: baseurl + "Constrct/add_doc",
    ...
    function datashow() {
        ...
        if (role == "admin" || role == "staff") {
            ...
            $.ajax({
                type: "POST",
                url: baseurl + "Constrct/showdata_filtered",
                data: {
                    table_name: table_name,
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td id="download_' + data[i].id + '"><a href=' + baseurl + 'Constrct/download/' + data[i].id + '>' + download + '</a></td>' +
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "Constrct/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $(document).on("click", ".edit_data", function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Constrct/show_doc_id",
            data: {
                id: id,
                certificate_type: certificate_type,
                //table_name: table_name,
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'Constrct/doc_image_upload',
    ...
    $(document).on('click', '#btnapprove', function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Constrct/update_status",
    ...
    $(document).on('submit', '#reject_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Constrct/update_status2",
    ...
    $('#attachment2').ajaxfileupload({
        'action': baseurl + 'Constrct/doc_image_upload2',
    ...
    $(document).on('click', '.btnupload', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Constrct/get_unique",
    ...
    $(document).on('submit', '#upload_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Constrct/update_doc",

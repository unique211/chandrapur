$(document).ready(function() {
    ...
    function get_appmaxid() {
        $.ajax({
            type: "POST",
            url: baseurl + "Inherit/selectmaxid",
            dataType: "JSON",
            async: false,
            data: {
    ...
    $(document).on("submit", "#master_form", function(e) {
        ...
        var municipality_ward_no = $('#munici_ward_no').val();
        var date1 = $('#date').val();
        var language = $('#language').val();
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Inherit/adddata",

            data: {
                id: id,
                name: name,
                ward_no: ward_no,
                municipality_ward_no: municipality_ward_no,
                date: date,
                language: language,
                year: year,
                unique_no: unique,
            ...
            success: function(data) {
                ...
                if (r != 0 || r != "0") {
                    ...
                    for (var i = 0; i < r; i++) {
                        ...
                        var certificate_type = "Inheritance_Certificate";
                        //  table_name = "doc_upload";

                        //  alert(ref_id);
                        $.ajax({
                            type: "POST",
                            url: baseurl + "Inherit/add_doc",
    ...
    function datashow() {
        if (role == "admin" || role == "staff") {
            ...
            $.ajax({
                type: "POST",
                url: baseurl + "Inherit/showdata_filtered",
                data: {
                    table_name: table_name,
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td id="download_' + data[i].id + '"><a href=' + baseurl + 'Inherit/download/' + data[i].id + '>' + download + '</a></td>' +
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "Inherit/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $(document).on("click", ".edit_data", function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Inherit/show_doc_id",
            data: {
                id: id,
                certificate_type: certificate_type,
                //table_name: table_name,
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'Inherit/doc_image_upload',
    ...
    $(document).on('click', '#btnapprove', function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Inherit/update_status",
    ...
    $(document).on('submit', '#reject_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Inherit/update_status2",
    ...
    $('#attachment2').ajaxfileupload({
        'action': baseurl + 'Inherit/doc_image_upload2',
    ...
    $(document).on('click', '.btnupload', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Inherit/get_unique",
    ...
    $(document).on('submit', '#upload_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Inherit/update_doc",

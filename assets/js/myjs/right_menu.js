$(document).ready(function() {
    ...
    $(document).on("submit", "#master_form", function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Right_menu/adddata",
            data: {
                id: id,
                menu: menu,
                menu_m: menu_m,
    ...
    function datashow() {
        $.ajax({
            type: "POST",
            url: baseurl + "Right_menu/showdata",
            data: {
                table_name: table_name,
            },
            dataType: "JSON",
            ...
            success: function(data) {
                ...
                html += '<table id="myTable" class="table table-striped">' +
                    ...
                    '<th style="display:none;"><font style="font-weight:bold">Type</font></th>' +
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        url: baseurl + "Right_menu/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,

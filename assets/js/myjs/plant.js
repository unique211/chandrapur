$(document).ready(function() {
    ...
    function get_appmaxid() {
        $.ajax({
            type: "POST",
            url: baseurl + "Plant_c/selectmaxid",
            dataType: "JSON",
            async: false,
            data: {
            ...
            success: function(data) {
                ...
                if (r != 0 || r != "0") {
                    for (var i = 0; i < r; i++) {
                        ...
                        var certificate_type = "plant";
                        //  table_name = "doc_upload";

                        //  alert(ref_id);
                        $.ajax({
                            type: "POST",
                            url: baseurl + "Plant_c/add_doc",
    ...
    function datashow() {
        ...
        if (role == "admin" || role == "staff") {
            ...
            $.ajax({
                type: "POST",
                url: baseurl + "Plant_c/showdata_filtered",
                data: {
                    table_name: table_name,
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td id="download_' + data[i].id + '"><a href=' + baseurl + 'Plant_c/download/' + data[i].id + '>' + download + '</a></td>' +
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "Plant_c/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $(document).on("click", ".edit_data", function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Plant_c/show_doc_id",
            data: {
                id: id,
                certificate_type: certificate_type,
                //table_name: table_name,
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'Plant_c/doc_image_upload',
    ...
    $(document).on('click', '#btnapprove', function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Plant_c/update_status",
    ...
    $(document).on('submit', '#reject_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Plant_c/update_status2",
    ...
    $('#attachment2').ajaxfileupload({
        'action': baseurl + 'Plant_c/doc_image_upload2',
    ...
    $(document).on('click', '.btnupload', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Plant_c/get_unique",
    ...
    $(document).on('submit', '#upload_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Plant_c/update_doc",

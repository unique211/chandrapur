$(document).ready(function() {
    var table_name = "new_developments";
    $(document).on("submit", "#master_form", function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "New_developments/adddata",
            data: {
                id: id,
                desc: desc,
                desc_m: desc_m,
    ...
    function datashow() {
        $.ajax({
            type: "POST",
            url: baseurl + "New_developments/showdata",
            data: {
                table_name: table_name,
            },
            dataType: "JSON",
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        url: baseurl + "New_developments/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'New_developments/doc_image_upload',

$(document).ready(function() {
    var table_name = "disaster_management";
    $(document).on("submit", "#master_form", function(e) {
        ...
        var file2 = $('#file_attachother1').val();
        $.ajax({
            type: "POST",
            url: baseurl + "Disaster_management/adddata",
            data: {
                id: id,
                parent: parent,
                file: file,
    ...
    function datashow() {
        $.ajax({
            type: "POST",
            url: baseurl + "Disaster_management/showdata",
            data: {
                table_name: table_name,
            },
            dataType: "JSON",
            ...
            success: function(data) {
                ...
                html += '<table id="myTable" class="table table-striped">' +
                    ...
                    '<th style="display:none"><font style="font-weight:bold">File2</font></th>' +
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    html += '<tr>' +
                        ...
                        '<td  style="display:none" id="file2_' + data[i].id + '">' + data[i].file2 + '</td>' +
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    $.ajax({
                        type: "POST",
                        url: baseurl + "Disaster_management/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $(document).on("click", ".edit_data", function() {
        ...
        $('#file_attachother1').val(file2);
        $("#msg1").html("<font id='doc_image_name1' color='green'>" + file2 + "</font>");
    });
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'Disaster_management/doc_image_upload',
    ...
    $('#attachment1').ajaxfileupload({
        'action': baseurl + 'Disaster_management/doc_image_upload1',

$(document).ready(function() {
    ...
    function get_appmaxid() {
        $.ajax({
            type: "POST",
            url: baseurl + "Zone_c/selectmaxid",
            dataType: "JSON",
            async: false,
            data: {
            ...
            success: function(data) {
                ...
                if (r != 0 || r != "0") {
                    for (var i = 0; i < r; i++) {
                        ...
                        var certificate_type = "zone";
                        //  table_name = "doc_upload";

                        //  alert(ref_id);
                        $.ajax({
                            type: "POST",
                            url: baseurl + "Zone_c/add_doc",
    ...
    function datashow() {
        ...
        if (role == "admin" || role == "staff") {
            ...
            $.ajax({
                type: "POST",
                url: baseurl + "Zone_c/showdata_filtered",
                data: {
                    table_name: table_name,
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td id="download_' + data[i].id + '"><a href=' + baseurl + 'Zone_c/download/' + data[i].id + '>' + download + '</a></td>' +
    ...
    $(document).on("click", ".edit_data", function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Zone_c/show_doc_id",
            data: {
                id: id,
                certificate_type: certificate_type,
                //table_name: table_name,
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'Zone_c/doc_image_upload',
    ...
    $(document).on('click', '#btnapprove', function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Zone_c/update_status",
    ...
    $(document).on('submit', '#reject_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Zone_c/update_status2",
    ...
    $('#attachment2').ajaxfileupload({
        'action': baseurl + 'Zone_c/doc_image_upload2',

$(document).ready(function() {
    ...
    function get_appmaxid() {
        $.ajax({
            type: "POST",
            url: baseurl + "Outstanding_c/selectmaxid",
            dataType: "JSON",
            async: false,
            data: {
                table_name: 'outstanding_certificate',
                id: 'sr_no',
            },
    ...
    $(document).on("submit", "#master_form", function(e) {
        ...
        var name = $('#name').val();
        var income_no = $('#income_no').val();
        var app_date1 = $('#app_date').val();
        var name2 = $('#name2').val();
        var address = $('#address').val();
        var res_date1 = $('#res_date').val();
        var language = $('#language').val();
        ...
        var dateslt = app_date1.split('/');
        var app_date = dateslt[2] + '-' + dateslt[1] + '-' + dateslt[0];
        var dateslt = res_date1.split('/');
        var res_date = dateslt[2] + '-' + dateslt[1] + '-' + dateslt[0];

        $.ajax({
            type: "POST",
            url: baseurl + "Outstanding_c/adddata",
            ...
            success: function(data) {
                ...
                if (r != 0 || r != "0") {
                    for (var i = 0; i < r; i++) {
                        ...
                        var certificate_type = "outstanding";
                        //  table_name = "doc_upload";

                        //  alert(ref_id);
                        $.ajax({
                            type: "POST",
                            url: baseurl + "Outstanding_c/add_doc",
    ...
    function datashow() {
        ...
        if (role == "admin" || role == "staff") {
            ...
            $.ajax({
                type: "POST",
                url: baseurl + "Outstanding_c/showdata_filtered",
                data: {
                    table_name: table_name,
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td id="download_' + data[i].id + '"><a href=' + baseurl + 'Outstanding_c/download/' + data[i].id + '>' + download + '</a></td>' +
            ...
            $.ajax({
                type: "POST",
                url: baseurl + "Outstanding_c/showdata",
                data: {
                    table_name: table_name,
        ...
        if (id1 != "") {
            swal({
                ...
                function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "Outstanding_c/deletedata",
                        dataType: "JSON",
                        data: {
                            id: id1,
                            table_name: table_name,
    ...
    $(document).on("click", ".edit_data", function() {
        ...
        var income_no = $('#income_no_' + id).html();
        var app_date1 = $('#app_date1_' + id).html();
        var name2 = $('#name2_' + id).html();
        var address = $('#address_' + id).html();
        var res_date1 = $('#res_date1_' + id).html();
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Outstanding_c/show_doc_id",
            data: {
                id: id,
                certificate_type: certificate_type,
                //table_name: table_name,
        ...
        $('#name').val(name);
        $('#income_no').val(income_no);
        $('#app_date').val(app_date1);
        $('#name2').val(name2);
        $('#address').val(address);
        $('#res_date').val(res_date1);
        $('#language').val(language);
    ...
    $('#attachment').ajaxfileupload({
        'action': baseurl + 'Outstanding_c/doc_image_upload',
    ...
    $(document).on('click', '#btnapprove', function() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Outstanding_c/update_status",
    ...
    $(document).on('submit', '#reject_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Outstanding_c/update_status2",
    ...
    $('#attachment2').ajaxfileupload({
        'action': baseurl + 'Outstanding_c/doc_image_upload2',
    ...
    $(document).on('click', '.btnupload', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Outstanding_c/get_unique",
    ...
    $(document).on('submit', '#upload_form', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "Outstanding_c/update_doc",
